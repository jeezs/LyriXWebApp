...
Opal.modules["lyricist_buttons"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    return $def(self, '$build_control_buttons', function $$build_control_buttons() {
      ...
      $send(next_word, 'touch', ["down"], function $$20(){var self = $$20.$$s == null ? this : $$20.$$s, lyrics = nil, sorted_keys = nil, next_index = nil, next_position = nil, last_position = nil;
        if (self.audio_object == null) self.audio_object = nil;
        ...
        lyrics = self.$grab("main_line");
        sorted_keys = lyrics.$content().$keys().$sort();
        next_index = $send(sorted_keys, 'find_index', [], function $$21(key){var self = $$21.$$s == null ? this : $$21.$$s;
          if (self.actual_position == null) self.actual_position = nil;
      ...
      $send(next_word, 'touch', ["up"], function $$22(){var self = $$22.$$s == null ? this : $$22.$$s;
        if (self.playing == null) self.playing = nil;
        if (self.audio_object == null) self.audio_object = nil;
        if (self.actual_position == null) self.actual_position = nil;
      ...
      $send(import_lyrics, 'import', [true], function $$23(val){var self = $$23.$$s == null ? this : $$23.$$s, current_lyrix = nil;
      ...
      $send(save_edited_text, 'touch', [true], function $$24(val){var self = $$24.$$s == null ? this : $$24.$$s;
      ...
      $send(edit_import, 'touch', [true], function $$25(val){var self = $$25.$$s == null ? this : $$25.$$s, text_to_edit = nil;
        ...
        if ($truthy(self.edit_lyrics_mode)) {
          ...
          $send(text_to_edit, 'keyboard', ["down"], function $$26(native_event){var self = $$26.$$s == null ? this : $$26.$$s;
      ...
      $send(save_song, 'touch', [true], function $$27(){var self = $$27.$$s == null ? this : $$27.$$s, content_to_save = nil, list_tile = nil;
      ...
      $send(load_prev_song, 'touch', [true], function $$28(){var self = $$28.$$s == null ? this : $$28.$$s;
      ...
      $send(load_next_song, 'touch', [true], function $$29(){var self = $$29.$$s == null ? this : $$29.$$s;
      ...
      $send(load_song, 'touch', [true], function $$30(){var self = $$30.$$s == null ? this : $$30.$$s, load_file = nil, result = nil;
        ...
        if ($truthy(self.$grab("loader"))) {
          ...
          $send(load_file, 'import', [true], function $$31(val){var self = $$31.$$s == null ? this : $$31.$$s, current_lyricist = nil;
          ...
          return $send(result['$[]']("files"), 'each_with_index', [], function $$32(file, index){var self = $$32.$$s == null ? this : $$32.$$s, list_f = nil;
            ...
            return $send(list_f, 'touch', [true], function $$33(){var self = $$33.$$s == null ? this : $$33.$$s, file_content = nil, current_lyricist = nil, list_to_load = nil;
      ...
      return $send(song_title, 'keyboard', ["down"], function $$34(native_event){var self = $$34.$$s == null ? this : $$34.$$s, event = nil, title = nil;
