...
Opal.modules["lyricist_ui"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    $def(self, '$build_lyrics_viewer', function $$build_lyrics_viewer() {
      ...
      $send(lyrics_support, 'touch', [true], function $$1(){var self = $$1.$$s == null ? this : $$1.$$s;

        return self.$hide_all_panels()}, {$$s: self});
      $send(lyrics_support, 'touch', ["long"], function $$2(){var $a, top_f = nil;
    ...
    $def(self, '$build_timeline_slider', function $$build_timeline_slider() {
      ...
      $send(self.$grab("main_stage"), 'slider', [$$('LyricsStyle').$slider_style((new Map([["id", "timeline_slider"], ["attach", "bottom_bar"], ["range", (new Map([["color", "orange"]]))], ["min", 0], ["max", self.length], ["width", $$('LyricsStyle').$dimensions()['$[]']("slider_width")], ["value", 0], ["height", $$('LyricsStyle').$dimensions()['$[]']("slider_height")], ["left", $rb_plus($$('LyricsStyle').$dimensions()['$[]']("margin"), 33)], ["tag", []], ["top", $$('LyricsStyle').$dimensions()['$[]']("margin")], ["color", "orange"], ["cursor", (new Map([["color", "orange"], ["width", 25], ["height", 25]]))]])))], function $$4(value){var self = $$4.$$s == null ? this : $$4.$$s, lyrics = nil, counter = nil;
      ...
      return $send(self.$grab("timeline_slider_cursor"), 'touch', ["up"], function $$6(){var self = $$6.$$s == null ? this : $$6.$$s, counter = nil, prev_length = nil;
        ...
        if ($truthy(self.playing)) {
          ...
          return $send(counter, 'timer', [(new Map([["end", $$$($$('Float'), 'INFINITY')]]))], function $$7(value){var self = $$7.$$s == null ? this : $$7.$$s, lyrics = nil;
            if (self.length == null) self.length = nil;
    ...
    return $def(self, '$setup_lyrics_events', function $$setup_lyrics_events() {
      ...
      lyrics = self.$grab("lyric_viewer");
      return $send(lyrics, 'keyboard', ["down"], function $$8(native_event){var self = $$8.$$s == null ? this : $$8.$$s, event = nil;
...
Opal.modules["lyricist_editor"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    $def(self, '$show_lyrics_editor', function $$show_lyrics_editor(left_f, top_f) {
      ...
      editor_container = self.$grab("lyrics_support").$box($$('LyricsStyle').$container_style((new Map([["id", "lyrics_editor_container"], ["color", (new Map([["red", 0.12], ["green", 0.12], ["blue", 0.12], ["alpha", 0]]))], ["left", "auto"], ["width", 530], ["right", 0]]))));
      lyrics = self.$grab("lyric_viewer");
...
Opal.modules["lyricist_core"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    $proto.lyrics_anticipation_time = $proto.sorted_keys_cache = $proto.sorted_keys_cache_size = $proto.playing = $proto.number_of_lines = $proto.length = $proto.lyrics = $proto.default_length = nil;
