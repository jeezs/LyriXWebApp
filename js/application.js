...
Opal.queue(function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('box,length,play,pause,[],identity_generator,dimensions,colors,grab,button_style,text,text_style,timer,[]=,content,data,blink,split,each_with_index,*,decorations,touch,alert,alter_lyric_event,audio,display,new,element,init_audio,new_song,initialize_list_manager,init_lyrix');
