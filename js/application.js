...
Opal.modules["lyricist_ui"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $klass = Opal.klass, $def = Opal.def, $send = Opal.send, $eqeq = Opal.eqeq, $rb_plus = Opal.rb_plus, $truthy = Opal.truthy, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil;
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    $def(self, '$build_timeline_slider', function $$build_timeline_slider() {
      ...
      $send(self.$grab("main_stage"), 'slider', [$$('LyricsStyle').$slider_style((new Map([["id", "timeline_slider"], ["attach", "bottom_bar"], ["range", (new Map([["color", "orange"]]))], ["min", 0], ["max", self.length], ["width", $$('LyricsStyle').$dimensions()['$[]']("slider_width")], ["value", 0], ["height", $$('LyricsStyle').$dimensions()['$[]']("slider_height")], ["left", $rb_plus($$('LyricsStyle').$dimensions()['$[]']("margin"), 33)], ["tag", []], ["top", $$('LyricsStyle').$dimensions()['$[]']("margin")], ["color", "orange"], ["cursor", (new Map([["color", "orange"], ["width", 25], ["height", 25]]))]])))], function $$4(value){var self = $$4.$$s == null ? this : $$4.$$s;
...
Opal.modules["lyricist_buttons"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    return $def(self, '$build_control_buttons', function $$build_control_buttons() {
      ...
      load_prev_song = self.$button((new Map([["label", "prev."], ["id", "load_prev_song"], ["top", $$('LyricsStyle').$dimensions()['$[]']("margin")], ["left", 535], ["right", $$('LyricsStyle').$dimensions()['$[]']("margin")], ["parent", "bottom_bar"]])));
      ...
      load_next_song = self.$button((new Map([["label", "next"], ["id", "load_next_song"], ["top", $$('LyricsStyle').$dimensions()['$[]']("margin")], ["left", 593], ["right", $$('LyricsStyle').$dimensions()['$[]']("margin")], ["parent", "bottom_bar"]])));
      ...
      song_title = self.$button((new Map([["label", self.title], ["id", "title"], ["top", $$('LyricsStyle').$dimensions()['$[]']("margin")], ["left", 250], ["width", 120], ["edit", true], ["parent", "tool_bar"]])));
...
Opal.modules["lyricist_core"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    $def(self, '$prepare_lyrics_display', function $$prepare_lyrics_display() {
      ...
      lyrics_support = self.$grab("lyrics_support");
      lyrics_support.$text((new Map([["left", 3], ["width", $$('LyricsStyle').$dimensions()['$[]']("line_width")], ["data", ""], ["id", "main_line"], ["top", 39], ["edit", false], ["component", (new Map([["size", $$('LyricsStyle').$dimensions()['$[]']("text_xlarge")]]))], ["position", "absolute"], ["content", (new Map([[0, ""]]))], ["context", "insert"]])));
      ...
      $send(Opal.Range.$new(1,self.number_of_lines, true), 'each', [], function $$5(index){var top_position = nil;
        ...
        return lyrics_support.$text((new Map([["id", "my_line_" + (index)], ["data", "next lines"], ["component", (new Map([["size", $$('LyricsStyle').$dimensions()['$[]']("next_Line_lyrics_size")]]))], ["top", $rb_times(top_position, $$('LyricsStyle').$dimensions()['$[]']("percent_offset_between_lines"))]])).$merge(common_style));});
