...
Opal.modules["lyricist_ui"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    $def(self, '$build_song_support', function $$build_song_support() {
      ...
      self.$grab("lyrics_support").$box((new Map([["id", "import_module"], ["top", $$('LyricsStyle').$dimensions()['$[]']("tool_bar_height")], ["left", 0], ["width", 399], ["bottom", 50], ["height", "auto"], ["smooth", $$('LyricsStyle').$decorations()['$[]']("standard_smooth")], ["color", $$('LyricsStyle').$colors()['$[]']("container_bg")], ["shadow", $$('LyricsStyle').$decorations()['$[]']("shadow")], ["depth", 2]])));
...
Opal.modules["lyricist_editor"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    $def(self, '$show_lyrics_editor', function $$show_lyrics_editor(left_f, top_f) {
      ...
      editor_container = self.$grab("lyrics_support").$box($$('LyricsStyle').$container_style((new Map([["id", "lyrics_editor_container"], ["color", (new Map([["red", 0.12], ["green", 0.12], ["blue", 0.12], ["alpha", 0]]))]]))));
      lyrics = self.$grab("lyric_viewer");
