...
Opal.modules["lyricist_ui"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    $def(self, '$build_tool_bar', function $$build_tool_bar() {
      ...
      self.$grab("main_stage").$box((new Map([["id", "tool_bar"], ["color", $$('LyricsStyle').$colors()['$[]']("container_bg")], ["shadow", $$('LyricsStyle').$decorations()['$[]']("standard_shadow")], ["top", 0], ["left", 0], ["right", 0], ["width", "auto"], ["height", $$('LyricsStyle').$dimensions()['$[]']("tool_bar_height")], ["opacity", 1], ["depth", 3], ["overflow", "auto"]])));
      return self.$grab("main_stage").$box((new Map([["id", "bottom_bar"], ["color", $$('LyricsStyle').$colors()['$[]']("container_bg")], ["shadow", $$('LyricsStyle').$decorations()['$[]']("standard_shadow")], ["top", "auto"], ["bottom", 0], ["left", 0], ["right", 0], ["width", "auto"], ["height", $$('LyricsStyle').$dimensions()['$[]']("tool_bar_height")], ["opacity", 1], ["depth", 3], ["overflow", "auto"]])));
    });
    ...
    return $def(self, '$setup_lyrics_events', function $$setup_lyrics_events() {
      ...
      return $send(lyrics, 'keyboard', ["down"], function $$7(native_event){var self = $$7.$$s == null ? this : $$7.$$s, event = nil;
        ...
        if ($eqeq(event['$[]']("keyCode").$to_s(), "13")) {
          ...
          return self.$puts("OK 7 case song: " + (self.$current_song()) + " " + (self.list));
        } else {
          return nil
        };}, {$$s: self});
    });
...
Opal.modules["lyricist_buttons"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    return $def(self, '$build_control_buttons', function $$build_control_buttons() {
      ...
      save_song = self.$button((new Map([["label", "save"], ["id", "save"], ["top", $$('LyricsStyle').$dimensions()['$[]']("margin")], ["left", "auto"], ["right", $$('LyricsStyle').$dimensions()['$[]']("margin")], ["parent", "bottom_bar"]])));
      ...
      load_song = self.$button((new Map([["label", "load"], ["id", "load"], ["top", $$('LyricsStyle').$dimensions()['$[]']("margin")], ["left", "auto"], ["right", 65], ["parent", "bottom_bar"]])));
...
Opal.modules["list"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $klass = Opal.klass, $rb_times = Opal.rb_times, $send = Opal.send, $eqeq = Opal.eqeq, $truthy = Opal.truthy, $def = Opal.def, $rb_plus = Opal.rb_plus, $thrower = Opal.thrower, $to_ary = Opal.to_ary, $not = Opal.not, $nesting = [], nil = Opal.nil;

  Opal.add_stubs('button,[],dimensions,positions,box,grab,colors,text,*,keyboard,Native,==,to_s,data,blink,preventDefault,touch,display,delete,refresh_song_list,add_current_song_to_list,save_playlist,clear,sort_by,keys,to_i,each,load_song_from_list,delete_song_from_list,wait,alert,reorder_song,+,stop_audio,timer,init_audio,content,parse_song_lyrics,full_refresh_viewer,reorder_all_songs,[]=,to_a,each_with_index,empty?,max,map,to_proc,save_file,!,is_a?,build_list_manager');
  return (function($base, $super, $parent_nesting) {
    var self = $klass($base, $super, 'Lyricist');
    ...
    $def(self, '$build_list_manager', function $$build_list_manager() {
      var self = this, list_button = nil, list_title_bar = nil, title_bar_list_text = nil, list_container = nil, add_song = nil, save_list = nil;
      ...
      title_bar_list_text = list_title_bar.$text((new Map([["position", "absolute"], ["top", $rb_times($$('LyricsStyle').$dimensions()['$[]']("margin"), 3)], ["left", $rb_times($$('LyricsStyle').$dimensions()['$[]']("margin"), 3)], ["data", "List name"], ["edit", true], ["color", $$('LyricsStyle').$colors()['$[]']("secondary")]])));
      ...
      list_container = self.$grab("main_stage").$box((new Map([["id", "list_container"], ["width", 380], ["height", "auto"], ["top", 50], ["bottom", 0], ["left", 10], ["color", $$('LyricsStyle').$colors()['$[]']("background")], ["attach", "list_panel"]])));
    ...
    $def(self, '$refresh_song_list', function $$refresh_song_list() {
      ...
      sorted_keys = $send(self.list.$keys(), 'sort_by', [], function $$5(k){
        
        if (k == null) k = nil;
        return k.$to_i();});
      top_position = 10;
      return $send(sorted_keys, 'each', [], function $$6(key){var self = $$6.$$s == null ? this : $$6.$$s, item = nil, item_container = nil, order_input = nil, load_button = nil, delete_button = nil;
        if (self.list == null) self.list = nil;
        ...
        $send(load_button, 'touch', [true], function $$7(){var self = $$7.$$s == null ? this : $$7.$$s;

          return self.$load_song_from_list(key)}, {$$s: self});
        $send(delete_button, 'touch', [true], function $$8(){var self = $$8.$$s == null ? this : $$8.$$s;
