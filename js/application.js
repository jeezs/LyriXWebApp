...
Opal.modules["lyricist_buttons"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    return $def(self, '$build_control_buttons', function $$build_control_buttons() {
      ...
      save_edited_text = self.$button((new Map([["label", "save"], ["id", "save_editt"], ["top", $$('LyricsStyle').$dimensions()['$[]']("margin")], ["left", "auto"], ["right", 55], ["parent", "import_module"]])));
      ...
      edit_import = self.$button((new Map([["label", "edit"], ["id", "edit_import"], ["top", $$('LyricsStyle').$dimensions()['$[]']("margin")], ["left", "auto"], ["right", 5], ["parent", "import_module"]])));
      $send(edit_import, 'touch', [true], function $$22(val){var self = $$22.$$s == null ? this : $$22.$$s, text_to_edit = nil;
        ...
        return $send(text_to_edit, 'keyboard', ["down"], function $$23(native_event){var self = $$23.$$s == null ? this : $$23.$$s;
...
Opal.queue(function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('box,length,play,pause,[],identity_generator,dimensions,colors,grab,button_style,text,text_style,timer,[]=,content,data,blink,split,each_with_index,to_sym,*,decorations,touch,alter_lyric_event,audio,display,new,element,init_audio,new_song,initialize_list_manager,init_lyrix');
  ...
  self.$box((new Map([["id", "main_stage"], ["width", "100%"], ["height", "100%"], ["color", "red"], ["overflow", "hidden"]])));
  (function($base, $super) {
