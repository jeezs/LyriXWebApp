Opal.modules["lyrics_style"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return (function($base, $super) {
    ...
    $defs(self, '$colors', function $$colors() {
      ...
      return (new Map([["first_line_color", (new Map([["red", 0.93], ["green", 0.93], ["blue", 0.93]]))], ["other_lines_color", (new Map([["red", 0.7], ["green", 0.7], ["blue", 0.7]]))], ["primary", (new Map([["red", 0.15], ["green", 0.15], ["blue", 0.15]]))], ["secondary", (new Map([["red", 0.72], ["green", 0.52], ["blue", 0.52]]))], ["third", (new Map([["red", 0.32], ["green", 0.32], ["blue", 0.32]]))], ["accent", (new Map([["red", 0.9], ["green", 0.3], ["blue", 0.6]]))], ["danger", (new Map([["red", 1], ["green", 0], ["blue", 0], ["alpha", 0.3]]))], ["success", (new Map([["red", 0.3], ["green", 0.3], ["blue", 0.3]]))], ["warning", (new Map([["red", 0.95], ["green", 0.7], ["blue", 0.2]]))], ["info", (new Map([["red", 0.3], ["green", 0.7], ["blue", 0.95]]))], ["background", (new Map([["red", 0.3], ["green", 0.3], ["blue", 0.3]]))], ["record", (new Map([["red", 0.9], ["green", 0.3], ["blue", 0.6], ["alpha", 0.8]]))], ["text_primary", (new Map([["red", 0.95], ["green", 0.95], ["blue", 0.95]]))], ["text_secondary", (new Map([["red", 0.7], ["green", 0.7], ["blue", 0.85]]))], ["text_accent", (new Map([["red", 0.95], ["green", 0.5], ["blue", 0.8]]))], ["container_bg", (new Map([["red", 0.12], ["green", 0.12], ["blue", 0.12], ["alpha", 1]]))], ["container_dark", (new Map([["red", 0.1], ["green", 0.1], ["blue", 0.1], ["alpha", 0.95]]))], ["container_medium", (new Map([["red", 0.18], ["green", 0.18], ["blue", 0.18], ["alpha", 0.9]]))], ["container_light", (new Map([["red", 0.22], ["green", 0.22], ["blue", 0.3], ["alpha", 0.85]]))]]))
    });
    $defs(self, '$dimensions', function $$dimensions() {
      
      return (new Map([["percent_offset_between_lines", 1.3], ["slider_width", 300], ["standard_width", 55], ["medium_width", 80], ["large_width", 140], ["container_width", 600], ["lyrics_width", 669], ["button_height", 25], ["medium_height", 40], ["large_height", 52], ["container_height", 500], ["tool_bar_height", 50], ["slider_height", 25], ["margin", 15], ["text_small", 12], ["text_medium", 14], ["text_normal", 16], ["text_large", 20], ["text_xlarge", 36], ["lyrics_size", 33], ["next_Line_lyrics_size", 30]]))
    });
    ...
    $defs(self, '$container_style', function $$container_style(options) {
      ...
      if (options == null) options = (new Map());
      style = (new Map([["width", self.$dimensions()['$[]']("container_width")], ["height", self.$dimensions()['$[]']("container_height")], ["smooth", self.$decorations()['$[]']("container_smooth")], ["shadow", self.$decorations()['$[]']("container_shadow")]]));
      return style.$merge(options);
    }, -1);
...
Opal.modules["lyricist_base"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $klass = Opal.klass, $send2 = Opal.send2, $find_super = Opal.find_super, $truthy = Opal.truthy, $def = Opal.def, $send = Opal.send, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil;

  Opal.add_stubs('attr_accessor,build_ui,new_song,audio,grab,top,zero?,left,right,[],dimensions,width,height,depth=,depth,bottom,content,refresh_viewer');
  return (function($base, $super, $parent_nesting) {
    ...
    $def(self, '$initialize', function $$initialize(content) {
      ...
      self.original_number_of_lines = 3;
    ...
    $def(self, '$fullscreen', function $$fullscreen() {
      var $a, self = this, lyrics_support = nil, top_f = nil;

      
      lyrics_support = self.$grab("lyrics_support");
      top_f = lyrics_support.$top();
      if ($truthy(top_f['$zero?']())) {
    ...
    return $def(self, '$new_song', function $$new_song(content) {
      ...
      self.lyrics = content;
      self.$grab("main_line").$content(content);
...
Opal.modules["lyricist_ui"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $klass = Opal.klass, $def = Opal.def, $rb_plus = Opal.rb_plus, $send = Opal.send, $eqeq = Opal.eqeq, $truthy = Opal.truthy, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil;

  Opal.add_stubs('build_tool_bar,build_song_support,build_control_buttons,build_lyrics_viewer,prepare_lyrics_display,build_timeline_slider,button,+,[],positions,dimensions,overflow,grab,text,colors,box,touch,fullscreen,timer,keyboard,Native,==,to_s,content,preventDefault,alter_lyric_event,update_song_listing,decorations,shadow,importer,data,load_strategy,slider,slider_style,update_lyrics,stop_audio,play_audio,hide_all_panels,find_key_by_title,delete_song_from_list,add_current_song_to_list,refresh_song_list');
  return (function($base, $super, $parent_nesting) {
    var self = $klass($base, $super, 'Lyricist');
    ...
    $def(self, '$build_ui', function $$build_ui() {
      ...
      self.$prepare_lyrics_display();
      return self.$build_timeline_slider();
    });
    
    $def(self, '$build_lyrics_viewer', function $$build_lyrics_viewer() {
      var self = this, counter = nil, lyrics_support = nil;

      
      self.$button((new Map([["label", ""], ["id", "counter_support"], ["width", 99], ["left", $rb_plus($$('LyricsStyle').$positions()['$[]']("counter_left"), 25)], ["top", $$('LyricsStyle').$dimensions()['$[]']("margin")], ["parent", "tool_bar"]])));
      self.$grab("counter_support").$overflow("hidden");
      counter = self.$grab("counter_support").$text((new Map([["data", 0], ["content", "play"], ["left", 6], ["color", $$('LyricsStyle').$colors()['$[]']("secondary")], ["top", 6], ["position", "absolute"], ["id", "counter"], ["invert", true]])));
      lyrics_support = self.$grab("main_stage").$box((new Map([["id", "lyrics_support"], ["width", "auto"], ["height", "auto"], ["top", $$('LyricsStyle').$dimensions()['$[]']("tool_bar_height")], ["left", 0], ["right", 0], ["bottom", 0], ["overflow", "scroll"], ["color", $$('LyricsStyle').$colors()['$[]']("container_bg")]])));
      $send(lyrics_support, 'touch', ["long"], function $$1(){var self = $$1.$$s == null ? this : $$1.$$s;

        return self.$fullscreen()}, {$$s: self});
      return counter.$timer((new Map([["position", 88]])));
    });
    
    $def(self, '$setup_lyrics_events', function $$setup_lyrics_events() {
      var self = this, lyrics = nil;

      
      lyrics = self.$grab("main_line");
      return $send(lyrics, 'keyboard', ["down"], function $$2(native_event){var self = $$2.$$s == null ? this : $$2.$$s, event = nil;
    ...
    $def(self, '$build_song_support', function $$build_song_support() {
      ...
      self.$grab("lyrics_support").$box((new Map([["id", "import_module"], ["top", $$('LyricsStyle').$dimensions()['$[]']("tool_bar_height")], ["left", "auto"], ["right", 0], ["width", 399], ["bottom", 50], ["height", "auto"], ["smooth", $$('LyricsStyle').$decorations()['$[]']("standard_smooth")], ["color", $$('LyricsStyle').$colors()['$[]']("container_bg")], ["shadow", $$('LyricsStyle').$decorations()['$[]']("shadow")], ["depth", 2]])));
      support = self.$grab("import_module").$box((new Map([["id", "importer_support"], ["overflow", "auto"], ["top", 39], ["left", 3], ["bottom", 3], ["right", 3], ["height", "auto"], ["width", "auto"], ["smooth", $$('LyricsStyle').$decorations()['$[]']("standard_smooth")], ["color", $$('LyricsStyle').$colors()['$[]']("container_medium")]])));
      support.$shadow($$('LyricsStyle').$decorations()['$[]']("invert_shadow"));
      return $send(self, 'importer', [], function $$3(val){var self = $$3.$$s == null ? this : $$3.$$s, content = nil, filename = nil, current_lyricist = nil, formated_import = nil;
    ...
    $def(self, '$build_timeline_slider', function $$build_timeline_slider() {
      var self = this, lyrics = nil, counter = nil;

      
      lyrics = self.$grab("main_line");
      counter = self.$grab("counter");
      $send(self.$grab("main_stage"), 'slider', [$$('LyricsStyle').$slider_style((new Map([["id", "timeline_slider"], ["attach", "bottom_bar"], ["range", (new Map([["color", "orange"]]))], ["min", 0], ["max", self.length], ["width", $$('LyricsStyle').$dimensions()['$[]']("slider_width")], ["value", 0], ["height", $$('LyricsStyle').$dimensions()['$[]']("slider_height")], ["left", 25], ["tag", []], ["top", 6], ["color", "orange"], ["cursor", (new Map([["color", "orange"], ["width", 25], ["height", 25]]))]])))], function $$4(value){var self = $$4.$$s == null ? this : $$4.$$s;

        
        if (value == null) value = nil;
        counter.$data(value);
        self.$update_lyrics(value, lyrics);
        return (self.actual_position = value);}, {$$s: self});
      $send(self.$grab("timeline_slider_cursor"), 'touch', ["down"], function $$5(){var self = $$5.$$s == null ? this : $$5.$$s;
      ...
      return $send(self.$grab("timeline_slider_cursor"), 'touch', ["up"], function $$6(){var self = $$6.$$s == null ? this : $$6.$$s;
        if (self.playing == null) self.playing = nil;
        if (self.audio_object == null) self.audio_object = nil;
        if (self.actual_position == null) self.actual_position = nil;

        if ($truthy(self.playing)) {
          return self.$play_audio(self.audio_object, self.actual_position)
        } else {
          return nil
        }}, {$$s: self});
    });
    ...
    $def(self, '$build_tool_bar', function $$build_tool_bar() {
      var self = this, tool_bar = nil, bottom_bar = nil;

      
      tool_bar = self.$grab("main_stage").$box((new Map([["id", "tool_bar"], ["color", $$('LyricsStyle').$colors()['$[]']("container_bg")], ["shadow", $$('LyricsStyle').$decorations()['$[]']("standard_shadow")], ["top", 5], ["left", 0], ["right", 0], ["width", "auto"], ["height", $$('LyricsStyle').$dimensions()['$[]']("tool_bar_height")], ["opacity", 1], ["depth", 3], ["overflow", "auto"]])));
      bottom_bar = self.$grab("main_stage").$box((new Map([["id", "bottom_bar"], ["color", $$('LyricsStyle').$colors()['$[]']("container_bg")], ["shadow", $$('LyricsStyle').$decorations()['$[]']("standard_shadow")], ["top", "auto"], ["bottom", 5], ["left", 0], ["right", 0], ["width", "auto"], ["height", $$('LyricsStyle').$dimensions()['$[]']("tool_bar_height")], ["opacity", 1], ["depth", 3], ["overflow", "auto"]])));
      $send(tool_bar, 'touch', ["double"], function $$7(){var self = $$7.$$s == null ? this : $$7.$$s;

        return self.$hide_all_panels()}, {$$s: self});
      $send(bottom_bar, 'touch', ["double"], function $$8(){var self = $$8.$$s == null ? this : $$8.$$s;

        return self.$hide_all_panels()}, {$$s: self});
      $send(tool_bar, 'touch', ["long"], function $$9(){var self = $$9.$$s == null ? this : $$9.$$s;

        return self.$fullscreen()}, {$$s: self});
      return $send(bottom_bar, 'touch', ["long"], function $$10(){var self = $$10.$$s == null ? this : $$10.$$s;

        return self.$fullscreen()}, {$$s: self});
    });
    return $def(self, '$update_song_listing', function $$update_song_listing() {
...
Opal.modules["lyricist_buttons"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $klass = Opal.klass, $thrower = Opal.thrower, $def = Opal.def, $assign_ivar = Opal.assign_ivar, $truthy = Opal.truthy, $send = Opal.send, $rb_minus = Opal.rb_minus, $rb_divide = Opal.rb_divide, $rb_plus = Opal.rb_plus, $rb_lt = Opal.rb_lt, $eqeq = Opal.eqeq, $rb_gt = Opal.rb_gt, $lambda = Opal.lambda, $rb_times = Opal.rb_times, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil;

  Opal.add_stubs('box,grab,smooth,color,[],colors,shadow,decorations,center,touch,text,wait,data,size,-,/,load_song_from_list,play_lyrics,play_next_song,delete,data=,to_s,+,to_i,find_key_by_title,<,length,loading_countdown,puts,stop_audio,update_lyrics,build_timeline_slider,==,instance_variable_get,play,round,value,pause,timer,play_audio,downcase,extname,init_audio,basename,clear,parse_song_lyrics,display,clear_all,content,full_refresh_viewer,set_list,refresh_song_list,update_song_listing,to_f,duration,>,call,setTimeout,global,wait_for_duration,%,rjust,path,button,dimensions,show_lyrics_editor,positions,edit,stop_lyrics,sort,keys,rindex,find_index,last,import,set_imported_lyrics,save_file,keyboard,save_file_to_db,hide_all_panels,load_strategy,list_all_files_in_localstorage,each_with_index,position,left,top,*,load_file,Native,blink,preventDefault');
  return (function($base, $super, $parent_nesting) {
    var self = $klass($base, $super, 'Lyricist');

    var $nesting = [self].concat($parent_nesting), $$ = Opal.$r($nesting), $proto = self.$$prototype;

    $proto.list = $proto.title = $proto.audio_object = $proto.allow_next = $proto.playing = $proto.actual_position = nil;
    ...
    $def(self, '$loading_countdown', function $$loading_countdown(next_song, allow_countdown) {
      var self = this, countdown = nil, countdown_size = nil, countdown_label = nil;

      if ($truthy(allow_countdown)) {
        ...
        $send(countdown_label, 'touch', [true], function $$2(){var self = $$2.$$s == null ? this : $$2.$$s;

          return (self.allow_loading = false)}, {$$s: self});
        $send(self, 'wait', [1], function $$3(){var self = $$3.$$s == null ? this : $$3.$$s;

          
          countdown_label.$data(2);
          countdown_label.$size($rb_minus(countdown_size, $rb_divide(countdown_size, 3)));
          countdown_label.$center(true);
          return $send(self, 'wait', [1], function $$4(){
            
            countdown_label.$data(1);
            countdown_label.$size($rb_minus(countdown_size, $rb_divide(countdown_size, 3)));
            return countdown_label.$center(true);});}, {$$s: self});
        return $send(self, 'wait', [3], function $$5(){var self = $$5.$$s == null ? this : $$5.$$s;
          ...
          if ($truthy(self.allow_loading)) {
            ...
            self.$play_next_song((new Map([["current", true], ["immediate", true]])))
          };
          return countdown.$delete((new Map([["recursive", true]])));}, {$$s: self});
      } else {
        return self.$load_song_from_list(next_song)
      }
    });
    
    $def(self, '$play_next_song', function $$play_next_song(params) {
      var self = this, song_to_load = nil, loading_countdown = nil, next_song = nil;

      
      if (params == null) params = (new Map());
      song_to_load = ($truthy(params['$[]']("prev")) ? (-1) : (1));
      if ($truthy(params['$[]']("current"))) {
        song_to_load = 0
      };
      loading_countdown = ($truthy(params['$[]']("immediate")) ? (false) : (true));
      self.allow_next = false;
      self.$grab("main_line")['$data=']("");
      next_song = $rb_plus(self.$find_key_by_title(self.list, self.title).$to_i(), song_to_load).$to_s();
      if ($truthy($rb_lt(next_song.$to_i(), $rb_plus(self.list.$length(), 1)))) {
        return self.$loading_countdown(next_song, loading_countdown)
      } else {
        return $send(self, 'wait', [1], function $$6(){var self = $$6.$$s == null ? this : $$6.$$s, current_song = nil;
    ...
    $def(self, '$stop_lyrics', function $$stop_lyrics() {
      ...
      lyrics = self.$grab("main_line");
      self.$update_lyrics(0, lyrics);
      self.$grab("timeline_slider").$delete((new Map([["force", true]])));
      self.$build_timeline_slider();
      self.playing = false;
      self.actual_position = 0;
      self.$grab("counter").$data(0);
      if (($eqeq(self.$grab("main_line").$data(), "-end-") && ($truthy(self.allow_next)))) {
    ...
    $def(self, '$play_audio', function $$play_audio(audio_object, actual_position) {
      var self = this, current_lyricist = nil, slider = nil;

      
      current_lyricist = self.$grab("the_lyricist").$data();
      self.length = current_lyricist.$instance_variable_get("@length");
      self.record = current_lyricist.$instance_variable_get("@record");
      current_lyricist.$instance_variable_get("@actual_position");
      slider = self.$grab("timeline_slider");
      $send(audio_object, 'play', [actual_position], function $$7(params){var value = nil;
    ...
    $def(self, '$stop_audio', function $$stop_audio(audio_object) {
    ...
    $def(self, '$load_strategy', function $$load_strategy(val) {try { 
      ...
      switch ($$('File').$extname(filename).$downcase().valueOf()) {
        ...
        case ".lrx":
          ...
          current_lyricist.$init_audio(audio_path);
          self.$grab("main_line").$content(lyrics);
          self.lyrics = self.$grab("main_line").$content(lyrics);
    ...
    $def(self, '$wait_for_duration', function $$wait_for_duration(audio_object, callback) {
      ...
      if (($truthy(duration_value) && ($truthy($rb_gt(duration_value, 0))))) {
        ...
        return $$('JS').$global().$setTimeout($lambda(function $$8(){var self = $$8.$$s == null ? this : $$8.$$s;
    ...
    $def(self, '$init_audio', function $$init_audio(audio_path) {
      ...
      return self.$wait_for_duration(self.audio_object, $lambda(function $$9(duration){var self = $$9.$$s == null ? this : $$9.$$s;

        
        if (duration == null) duration = nil;
        self.default_length = duration;
        self.length = duration;
        return self.$full_refresh_viewer(0);}, {$$s: self}));
    });
    return $def(self, '$build_control_buttons', function $$build_control_buttons() {
      var self = this, play = nil, edit_lyrics = nil, erase = nil, view_importer = nil, record = nil, clear = nil, stop = nil, prev_word = nil, next_word = nil, import_lyrics = nil, save_edited_text = nil, edit_import = nil, save_song = nil, load_prev_song = nil, load_next_song = nil, load_song = nil, song_title = nil;

      
      play = self.$button((new Map([["label", "play"], ["id", "play"], ["top", $$('LyricsStyle').$dimensions()['$[]']("margin")], ["left", 25], ["parent", "tool_bar"]])));
      $send(play, 'touch', [true], function $$10(){var self = $$10.$$s == null ? this : $$10.$$s;

        return self.$play_lyrics()}, {$$s: self});
      edit_lyrics = self.$button((new Map([["label", "Edit"], ["id", "edit_lyrics_button"], ["left", 635], ["right", $$('LyricsStyle').$dimensions()['$[]']("margin")], ["top", $$('LyricsStyle').$dimensions()['$[]']("margin")], ["size", $$('LyricsStyle').$dimensions()['$[]']("text_medium")], ["parent", "tool_bar"]])));
      $send(edit_lyrics, 'touch', [true], function $$11(){var self = $$11.$$s == null ? this : $$11.$$s;
      ...
      erase = self.$button((new Map([["id", "erase"], ["label", "clear"], ["color", $$('LyricsStyle').$colors()['$[]']("accent")], ["top", $$('LyricsStyle').$dimensions()['$[]']("margin")], ["left", $rb_plus($$('LyricsStyle').$positions()['$[]']("fourth_column"), 25)], ["parent", "tool_bar"]])));
      $send(erase, 'touch', [true], function $$12(){var self = $$12.$$s == null ? this : $$12.$$s;

        
        self.$clear_all();
        return self.$update_song_listing();}, {$$s: self});
      view_importer = self.$button((new Map([["id", "import_viewer"], ["label", "lyrics"], ["top", $$('LyricsStyle').$dimensions()['$[]']("margin")], ["left", 570], ["right", $$('LyricsStyle').$positions()['$[]']("second_column")], ["parent", "tool_bar"]])));
      $send(view_importer, 'touch', [true], function $$13(){var self = $$13.$$s == null ? this : $$13.$$s, import_drag = nil;
        ...
        return self.$update_song_listing();}, {$$s: self});
      record = self.$button((new Map([["label", "modify"], ["id", "record"], ["top", $$('LyricsStyle').$dimensions()['$[]']("margin")], ["left", $rb_plus($$('LyricsStyle').$positions()['$[]']("third_column"), 25)], ["parent", "tool_bar"]])));
      $send(record, 'touch', [true], function $$14(){var self = $$14.$$s == null ? this : $$14.$$s, prev_postion = nil, lyric_viewer = nil, counter = nil, lyrics = nil;
        if (self.actual_position == null) self.actual_position = nil;
        ...
        lyric_viewer = self.$grab("main_line");
      ...
      clear = self.$button((new Map([["label", "clear"], ["id", "clear"], ["top", $$('LyricsStyle').$dimensions()['$[]']("margin")], ["color", $$('LyricsStyle').$colors()['$[]']("accent")], ["left", $rb_plus($$('LyricsStyle').$positions()['$[]']("second_column"), 25)], ["parent", "import_module"]])));
      $send(clear, 'touch', [true], function $$15(){var self = $$15.$$s == null ? this : $$15.$$s;

        return self.$grab("importer_support").$clear(true)}, {$$s: self});
      stop = self.$button((new Map([["label", "stop"], ["id", "stop"], ["top", $$('LyricsStyle').$dimensions()['$[]']("margin")], ["color", $$('LyricsStyle').$colors()['$[]']("secondary")], ["left", $rb_plus($$('LyricsStyle').$positions()['$[]']("second_column"), 25)], ["parent", "tool_bar"]])));
      $send(stop, 'touch', [true], function $$16(){var self = $$16.$$s == null ? this : $$16.$$s;

        return self.$stop_lyrics()}, {$$s: self});
      prev_word = self.$button((new Map([["label", "<"], ["width", 25], ["id", "previous"], ["top", 6], ["left", $$('LyricsStyle').$positions()['$[]']("prev")], ["parent", "bottom_bar"]])));
      next_word = self.$button((new Map([["label", ">"], ["width", 25], ["top", 6], ["id", "next"], ["left", $$('LyricsStyle').$positions()['$[]']("next")], ["parent", "bottom_bar"]])));
      $send(prev_word, 'touch', ["down"], function $$17(){var self = $$17.$$s == null ? this : $$17.$$s, lyrics = nil, sorted_keys = nil, prev_index = nil, prev_position = nil;
        if (self.audio_object == null) self.audio_object = nil;
        ...
        prev_index = $send(sorted_keys, 'rindex', [], function $$18(key){var self = $$18.$$s == null ? this : $$18.$$s;
          if (self.actual_position == null) self.actual_position = nil;

          
          if (key == null) key = nil;
          return $rb_lt(key, self.actual_position);}, {$$s: self});
        if ($truthy(prev_index)) {
          
          prev_position = sorted_keys['$[]'](prev_index);
          self.actual_position = prev_position;
          self.$update_lyrics(prev_position, lyrics);
      ...
      $send(prev_word, 'touch', ["up"], function $$19(){var self = $$19.$$s == null ? this : $$19.$$s;

        return $send(self, 'wait', [0.5], function $$20(){var self = $$20.$$s == null ? this : $$20.$$s;
          if (self.playing == null) self.playing = nil;
          if (self.audio_object == null) self.audio_object = nil;
          if (self.actual_position == null) self.actual_position = nil;
      ...
      $send(next_word, 'touch', ["down"], function $$21(){var self = $$21.$$s == null ? this : $$21.$$s, lyrics = nil, sorted_keys = nil, next_index = nil, next_position = nil, last_position = nil;
        if (self.audio_object == null) self.audio_object = nil;
        ...
        lyrics = self.$grab("main_line");
        sorted_keys = lyrics.$content().$keys().$sort();
        next_index = $send(sorted_keys, 'find_index', [], function $$22(key){var self = $$22.$$s == null ? this : $$22.$$s;
          if (self.actual_position == null) self.actual_position = nil;

          
          if (key == null) key = nil;
          return $rb_gt(key, self.actual_position);}, {$$s: self});
        if ($truthy(next_index)) {
          
          next_position = sorted_keys['$[]'](next_index);
          self.actual_position = next_position;
          self.$update_lyrics(next_position, lyrics);
          return self.$grab("timeline_slider").$value(next_position);
        } else {
          
          last_position = sorted_keys.$last();
          self.$update_lyrics(last_position, lyrics);
          return self.$grab("timeline_slider").$value(last_position);
        };}, {$$s: self});
      $send(next_word, 'touch', ["up"], function $$23(){var self = $$23.$$s == null ? this : $$23.$$s;
        if (self.playing == null) self.playing = nil;
        if (self.audio_object == null) self.audio_object = nil;
        if (self.actual_position == null) self.actual_position = nil;
      ...
      $send(import_lyrics, 'import', [true], function $$24(val){var self = $$24.$$s == null ? this : $$24.$$s, current_lyrix = nil;
      ...
      save_edited_text = self.$button((new Map([["label", "save"], ["id", "save_edit"], ["top", $$('LyricsStyle').$dimensions()['$[]']("margin")], ["left", "auto"], ["right", 66], ["parent", "import_module"]])));
      $send(save_edited_text, 'touch', [true], function $$25(val){var self = $$25.$$s == null ? this : $$25.$$s;
      ...
      $send(edit_import, 'touch', [true], function $$26(val){var self = $$26.$$s == null ? this : $$26.$$s, text_to_edit = nil;
        ...
        if ($truthy(self.edit_lyrics_mode)) {
          ...
          $send(text_to_edit, 'keyboard', ["down"], function $$27(native_event){var self = $$27.$$s == null ? this : $$27.$$s;
        ...
        return self.$update_song_listing();}, {$$s: self});
      save_song = self.$button((new Map([["label", "save"], ["id", "save"], ["top", 6], ["left", 470], ["right", $$('LyricsStyle').$dimensions()['$[]']("margin")], ["parent", "bottom_bar"]])));
      $send(save_song, 'touch', [true], function $$28(){var self = $$28.$$s == null ? this : $$28.$$s, content_to_save = nil, list_tile = nil;
        ...
        return self.$save_file_to_db(list_tile, content_to_save);}, {$$s: self});
      load_prev_song = self.$button((new Map([["label", "prev."], ["id", "load_prev_song"], ["top", 6], ["left", 535], ["right", $$('LyricsStyle').$dimensions()['$[]']("margin")], ["parent", "bottom_bar"]])));
      $send(load_prev_song, 'touch', [true], function $$29(){var self = $$29.$$s == null ? this : $$29.$$s;

        return self.$play_next_song((new Map([["prev", true], ["immediate", true]])))}, {$$s: self});
      load_next_song = self.$button((new Map([["label", "next"], ["id", "load_next_song"], ["top", 6], ["left", 593], ["right", $$('LyricsStyle').$dimensions()['$[]']("margin")], ["parent", "bottom_bar"]])));
      $send(load_next_song, 'touch', [true], function $$30(){var self = $$30.$$s == null ? this : $$30.$$s;

        return self.$play_next_song((new Map([["immediate", true]])))}, {$$s: self});
      load_song = self.$button((new Map([["label", "load"], ["id", "load"], ["top", 6], ["left", 410], ["right", 65], ["parent", "bottom_bar"]])));
      $send(load_song, 'touch', [true], function $$31(){var self = $$31.$$s == null ? this : $$31.$$s, load_file = nil, result = nil;

        if ($truthy(self.$grab("loader"))) {
          return self.$hide_all_panels()
        } else {
          
          self.$hide_all_panels();
          self.$grab("main_line").$box((new Map([["id", "loader"], ["width", 259], ["height", 333], ["smooth", 9], ["shadow", $$('LyricsStyle').$decorations()['$[]']("shadow")]])));
          load_file = self.$button((new Map([["label", "disk"], ["id", "disk_loader"], ["top", 3], ["left", 3], ["right", 65], ["parent", "loader"]])));
          $send(load_file, 'import', [true], function $$32(val){var self = $$32.$$s == null ? this : $$32.$$s, current_lyricist = nil;
          ...
          return $send(result['$[]']("files"), 'each_with_index', [], function $$33(file, index){var self = $$33.$$s == null ? this : $$33.$$s, list_f = nil;
            ...
            return $send(list_f, 'touch', [true], function $$34(){var self = $$34.$$s == null ? this : $$34.$$s, file_content = nil, current_lyricist = nil, list_to_load = nil;
      ...
      song_title = self.$button((new Map([["label", self.title], ["id", "title"], ["top", $$('LyricsStyle').$dimensions()['$[]']("margin")], ["left", $rb_plus(250, 25)], ["width", 120], ["edit", true], ["parent", "tool_bar"]])));
      return $send(song_title, 'keyboard', ["down"], function $$35(native_event){var self = $$35.$$s == null ? this : $$35.$$s, event = nil, title = nil;
...
Opal.modules["lyricist_editor"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $klass = Opal.klass, $rb_minus = Opal.rb_minus, $send = Opal.send, $to_ary = Opal.to_ary, $rb_plus = Opal.rb_plus, $rb_times = Opal.rb_times, $def = Opal.def, $eqeq = Opal.eqeq, $neqeq = Opal.neqeq, $truthy = Opal.truthy, $rb_gt = Opal.rb_gt, $not = Opal.not, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil;

  Opal.add_stubs('box,grab,container_style,-,to_px,touch,stop_propagation,prevent_default,prev,puts,to_h,sort,content,each_with_index,+,*,line_container_style,to_sym,text,text_style,to_s,[],dimensions,colors,setup_edit_line_events,build_update_button,build_delete_button,build_add_line_button,private,keyboard,Native,==,preventDefault,to_i,data,!=,delete,[]=,blink,timer,update_lyrics,full_refresh_viewer,update_song_listing,max,keys,>,action_button_style,left,top,show_lyrics_editor,show_add_dialog,build_dialog_buttons,!,empty?');
  return (function($base, $super, $parent_nesting) {
    var self = $klass($base, $super, 'Lyricist');
    ...
    $def(self, '$show_lyrics_editor', function $$show_lyrics_editor(left_f, top_f) {
      ...
      editor_container = self.$grab("lyrics_support").$box($$('LyricsStyle').$container_style((new Map([["id", "lyrics_editor_container"], ["color", (new Map([["red", 0.12], ["green", 0.12], ["blue", 0.12], ["alpha", 0]]))], ["left", $rb_minus(self.$grab("view").$to_px("width"), 530)], ["width", 530], ["right", 0], ["depth", 33]]))));
      $send(editor_container, 'touch', [true], function $$1(evt){var self = $$1.$$s == null ? this : $$1.$$s;
        ...
        evt.$prevent_default();
        evt.$prev();
        return self.$puts("jjj");}, {$$s: self});
      lyrics = self.$grab("main_line");
      sorted_lyrics = lyrics.$content().$sort().$to_h();
      $send(sorted_lyrics, 'each_with_index', [], function $$2($mlhs_tmp1, index){var $a, $b, self = $$2.$$s == null ? this : $$2.$$s, timecode = nil, text = nil, y_position = nil, line_container = nil, timecode_field = nil, text_field = nil;

        
        if ($mlhs_tmp1 == null) $mlhs_tmp1 = nil;
        if (index == null) index = nil;
        $b = $mlhs_tmp1, $a = $to_ary($b), (timecode = ($a[0] == null ? nil : $a[0])), (text = ($a[1] == null ? nil : $a[1])), $b;
        y_position = $rb_plus(70, $rb_times(index, 60));
        line_container = editor_container.$box($$('LyricsStyle').$line_container_style((new Map([["id", (("line_container_") + (index)).$to_sym()], ["top", y_position], ["color", (new Map([["red", 0.1], ["green", 0.1], ["blue", 0.1]]))]]))));
        ...
        self.$build_update_button(line_container, timecode, timecode_field, text_field, lyrics);
        return self.$build_delete_button(line_container, editor_container, timecode, lyrics);}, {$$s: self, $$has_top_level_mlhs_arg: true});
    ...
    $def(self, '$setup_edit_line_events', function $$setup_edit_line_events(line_container, timecode_field, text_field, timecode, lyrics) {
      ...
      $send(timecode_field, 'keyboard', ["dowm"], function $$3(native_event){var self = $$3.$$s == null ? this : $$3.$$s, event = nil, old_timecode = nil, new_timecode = nil, new_text = nil, counter = nil, current_position = nil, prev_position = nil;
        if (self.actual_position == null) self.actual_position = nil;
      ...
      return $send(text_field, 'keyboard', ["dowm"], function $$4(native_event){var self = $$4.$$s == null ? this : $$4.$$s, event = nil, old_timecode = nil, new_timecode = nil, new_text = nil, counter = nil, current_position = nil, max_timecode = nil, prev_position = nil;
    ...
    $def(self, '$build_update_button', function $$build_update_button(line_container, timecode, timecode_field, text_field, lyrics) {
      ...
      $send(update_button, 'touch', [true], function $$5(){var self = $$5.$$s == null ? this : $$5.$$s, old_timecode = nil, new_timecode = nil, new_text = nil, counter = nil, current_position = nil, max_timecode = nil, prev_position = nil;
        if (self.length == null) self.length = nil;
        if (self.actual_position == null) self.actual_position = nil;
    ...
    $def(self, '$build_delete_button', function $$build_delete_button(line_container, editor_container, timecode, lyrics) {
      ...
      $send(delete_button, 'touch', [true], function $$6(){var self = $$6.$$s == null ? this : $$6.$$s, prev_left = nil, prev_top = nil, counter = nil, current_position = nil;
    ...
    $def(self, '$build_add_line_button', function $$build_add_line_button(editor_container, sorted_lyrics, lyrics) {
      ...
      add_button = editor_container.$box($$('LyricsStyle').$line_container_style((new Map([["width", 520], ["height", 40], ["left", 10], ["top", 15], ["color", $$('LyricsStyle').$colors()['$[]']("success")]]))));
      ...
      $send(add_button, 'touch', [true], function $$7(){var self = $$7.$$s == null ? this : $$7.$$s;
    ...
    $def(self, '$show_add_dialog', function $$show_add_dialog(editor_container, lyrics) {
      ...
      dialog_container = self.$grab("lyrics_editor_container").$box($$('LyricsStyle').$container_style((new Map([["id", "add_dialog"], ["width", 300], ["height", 150], ["left", 120], ["top", 120], ["color", (new Map([["red", 0.1], ["green", 0.1], ["blue", 0.1]]))], ["position", "absolute"]]))));
      ...
      new_timecode_field = dialog_container.$text($$('LyricsStyle').$text_style((new Map([["id", "new_timecode"], ["data", 100], ["component", (new Map([["size", $$('LyricsStyle').$dimensions()['$[]']("text_normal")]]))], ["edit", true], ["width", 200], ["left", 110], ["top", 40]]))));
      $send(new_timecode_field, 'keyboard', ["down"], function $$8(native_event){var self = $$8.$$s == null ? this : $$8.$$s, event = nil;
      ...
      $send(new_text_field, 'keyboard', ["down"], function $$9(native_event){var self = $$9.$$s == null ? this : $$9.$$s, event = nil;
    ...
    return $def(self, '$build_dialog_buttons', function $$build_dialog_buttons(dialog_container, new_timecode_field, new_text_field, editor_container, lyrics) {
      ...
      confirm_button = dialog_container.$box($$('LyricsStyle').$action_button_style((new Map([["width", $$('LyricsStyle').$dimensions()['$[]']("large_width")], ["height", 30], ["left", 3], ["top", 110], ["color", $$('LyricsStyle').$colors()['$[]']("success")]]))));
      confirm_button.$text($$('LyricsStyle').$text_style((new Map([["data", "ok"], ["component", (new Map([["size", $$('LyricsStyle').$dimensions()['$[]']("text_normal")]]))], ["color", $$('LyricsStyle').$colors()['$[]']("text_primary")], ["left", 30], ["top", 5]]))));
      cancel_button = dialog_container.$box($$('LyricsStyle').$action_button_style((new Map([["width", $$('LyricsStyle').$dimensions()['$[]']("large_width")], ["height", 30], ["left", 150], ["top", 110], ["color", "gray"]]))));
      cancel_button.$text($$('LyricsStyle').$text_style((new Map([["data", "Cancel"], ["component", (new Map([["size", $$('LyricsStyle').$dimensions()['$[]']("text_normal")]]))], ["color", $$('LyricsStyle').$colors()['$[]']("text_primary")], ["left", 35], ["top", 5]]))));
      $send(confirm_button, 'touch', [true], function $$10(){var self = $$10.$$s == null ? this : $$10.$$s, prev_left = nil, prev_top = nil, new_timecode = nil, new_text = nil, counter = nil, current_position = nil;
        if (self.length == null) self.length = nil;
      ...
      return $send(cancel_button, 'touch', [true], function $$11(){
...
Opal.modules["lyricist_core"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $klass = Opal.klass, $truthy = Opal.truthy, $send = Opal.send, $rb_le = Opal.rb_le, $thrower = Opal.thrower, $rb_gt = Opal.rb_gt, $rb_plus = Opal.rb_plus, $rb_ge = Opal.rb_ge, $def = Opal.def, $eqeq = Opal.eqeq, $rb_times = Opal.rb_times, $neqeq = Opal.neqeq, $rb_lt = Opal.rb_lt, $range = Opal.range, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil;

  Opal.add_stubs('empty?,sort,keys,reverse_each,<=,nil?,first,<<,[],>,index,each,+,>=,size,==,grab,text,dimensions,colors,*,merge,setup_lyrics_events,color,wait,[]=,data,content,closest_values,!=,content=,stop_lyrics,each_with_index,<,delete,build_timeline_slider,value,rebuild_timeline_slider,respond_to?,update,cleanup_cache,play_lyrics,eval,call,puts');
  return (function($base, $super, $parent_nesting) {
    var self = $klass($base, $super, 'Lyricist');

    var $nesting = [self].concat($parent_nesting), $$ = Opal.$r($nesting), $proto = self.$$prototype;

    $proto.number_of_lines = $proto.actual_position = $proto.playing = $proto.length = $proto.lyrics = $proto.default_length = nil;
    
    
    $def(self, '$closest_values', function $$closest_values(hash, target, count) {
      var sorted_keys = nil, found_key = nil, result = nil, current_index = nil;
      ...
      found_key = nil;
      (function(){try { var $t_break = $thrower('break'); return $send(sorted_keys, 'reverse_each', [], function $$1(key){
        
        if (key == null) key = nil;
        if ($truthy($rb_le(key, target))) {
      ...
      if ($truthy(found_key)) {
        ...
        if ($truthy($rb_gt(count, 1))) {
          ...
          (function(){try { var $t_break = $thrower('break'); return $send(Opal.Range.$new(1,count, true), 'each', [], function $$2(i){var next_index = nil, next_key = nil;

            
            if (i == null) i = nil;
            next_index = $rb_plus(current_index, i);
            if ($truthy($rb_ge(next_index, sorted_keys.$size()))) {
              $t_break.$throw(nil, $$2.$$is_lambda)
            };
            next_key = sorted_keys['$[]'](next_index);
            if ($truthy(hash['$[]'](next_key))) {
              return result['$<<'](hash['$[]'](next_key))
            } else {
              return nil
            };})} catch($e) {
            if ($e === $t_break) return $e.$v;
    ...
    $def(self, '$prepare_lyrics_display', function $$prepare_lyrics_display() {
      var self = this, lyrics_support = nil, common_style = nil;

      
      lyrics_support = self.$grab("lyrics_support");
      lyrics_support.$text((new Map([["width", $$('LyricsStyle').$dimensions()['$[]']("line_width")], ["data", ""], ["id", "main_line"], ["top", 39], ["left", 39], ["edit", false], ["component", (new Map([["size", $$('LyricsStyle').$dimensions()['$[]']("text_xlarge")]]))], ["position", "absolute"], ["content", (new Map([[0, ""]]))], ["context", "insert"]])));
      ...
      $send(Opal.Range.$new(1,self.number_of_lines, true), 'each', [], function $$5(index){var top_position = nil;

        
        if (index == null) index = nil;
        top_position = $rb_plus($rb_times($$('LyricsStyle').$dimensions()['$[]']("next_Line_lyrics_size"), index), $rb_times($$('LyricsStyle').$dimensions()['$[]']("lyrics_size"), 3));
        return lyrics_support.$text((new Map([["id", "my_line_" + (index)], ["data", "next lines"], ["left", 39], ["component", (new Map([["size", $$('LyricsStyle').$dimensions()['$[]']("next_Line_lyrics_size")]]))], ["top", $rb_times(top_position, $$('LyricsStyle').$dimensions()['$[]']("percent_offset_between_lines"))]])).$merge(common_style));});
      return self.$setup_lyrics_events();
    });
    
    $def(self, '$alter_lyric_event', function $$alter_lyric_event() {
      var $a, self = this, lyrics = nil;

      
      lyrics = self.$grab("main_line");
      lyrics.$color($$('LyricsStyle').$colors()['$[]']("danger"));
      $send(self, 'wait', [1], function $$6(){
        return lyrics.$color($$('LyricsStyle').$colors()['$[]']("first_line_color"))});
      return ($a = [self.actual_position, lyrics.$data()], $send(lyrics.$content(), '[]=', $a), $a[$a.length - 1]);
    });
    
    $def(self, '$update_lyrics', function $$update_lyrics(value, target) {
      var self = this, lyrics_array = nil;

      
      lyrics_array = self.$closest_values(target.$content(), value, self.number_of_lines);
      if ($truthy(lyrics_array['$empty?']())) {
        return nil
      };
      if (($eqeq(target.$data(), lyrics_array['$[]'](0)) || ($neqeq(self.$grab("counter").$content(), "play")))) {
        return nil
      };
      ...
      return $send(lyrics_array, 'each_with_index', [], function $$7(lyric, index){var self = $$7.$$s == null ? this : $$7.$$s;
        if (self.number_of_lines == null) self.number_of_lines = nil;
        ...
        if ($truthy($rb_lt(index, self.number_of_lines))) {
          return self.$grab("my_line_" + (index)).$data(lyric)
        } else {
          return nil
        };}, {$$s: self});
    });
    ...
    $def(self, '$clear_all', function $$clear_all() {
      ...
      $send(Opal.Range.$new(1,self.number_of_lines, true), 'each', [], function $$8(index){var self = $$8.$$s == null ? this : $$8.$$s;

        
        if (index == null) index = nil;
        if ($truthy(self.$grab("my_line_" + (index)))) {
          return self.$grab("my_line_" + (index)).$data("")
        } else {
          return nil
        };}, {$$s: self});
      self.length = self.default_length;
    ...
    $def(self, '$reset_lyrics_system', function $$reset_lyrics_system() {
      var self = this;
      ...
      if ($truthy(self.playing)) {
        ...
        self.$stop_lyrics();
        return $send(self, 'wait', [0.5], function $$9(){var self = $$9.$$s == null ? this : $$9.$$s;
    ...
    $def(self, '$save_file', function $$save_file(filename, content, mime_type) {try { 
      var save_js = nil;
    ...
    return $def(self, '$inspect_lyrics_content', function $$inspect_lyrics_content() {
      var self = this, lyric_viewer = nil, content = nil, sorted_keys = nil;

      
      lyric_viewer = self.$grab("main_line");
      content = lyric_viewer.$content();
      if (($truthy(content) && ($truthy($rb_gt(content.$keys().$size(), 0))))) {
        
        sorted_keys = content.$keys().$sort();
        $send(sorted_keys['$[]']($range(0, 4, false)), 'each', [], function $$10(key){var self = $$10.$$s == null ? this : $$10.$$s;

          
          if (key == null) key = nil;
          return self.$puts("  " + (key) + ": " + (content['$[]'](key)));}, {$$s: self});
        return $send(sorted_keys['$[]']($range(-5, -1, false)), 'each', [], function $$11(key){var self = $$11.$$s == null ? this : $$11.$$s;
...
Opal.modules["list"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $klass = Opal.klass, $rb_plus = Opal.rb_plus, $rb_times = Opal.rb_times, $send = Opal.send, $eqeq = Opal.eqeq, $truthy = Opal.truthy, $def = Opal.def, $not = Opal.not, $thrower = Opal.thrower, $to_ary = Opal.to_ary, $neqeq = Opal.neqeq, $nesting = [], nil = Opal.nil;

  Opal.add_stubs('button,[],dimensions,+,positions,box,grab,colors,decorations,text,*,keyboard,Native,==,to_s,data,blink,preventDefault,touch,display,delete,refresh_song_list,update_song_listing,add_current_song_to_list,save_playlist,clear,!,empty?,dup,sort_by,keys,to_i,each,find_song_key_by_title,load_song_from_list,delete_song_from_list,reorder_song,prepare_lyrics_display,stop_audio,init_audio,content,parse_song_lyrics,full_refresh_viewer,[]=,reorder_all_songs,to_a,map,each_with_index,!=,max,to_proc,save_file,is_a?,build_list_manager');
  return (function($base, $super, $parent_nesting) {
    var self = $klass($base, $super, 'Lyricist');

    var $nesting = [self].concat($parent_nesting), $$ = Opal.$r($nesting), $proto = self.$$prototype;

    $proto.list = $proto.audio_object = $proto.title = $proto.number_of_lines = $proto.audio_path = $proto.imported_lyrics = $proto.list_title = nil;
    ...
    $def(self, '$build_list_manager', function $$build_list_manager() {
      ...
      list_button = self.$button((new Map([["label", "list"], ["id", "list_button"], ["top", $$('LyricsStyle').$dimensions()['$[]']("margin")], ["left", $rb_plus($$('LyricsStyle').$positions()['$[]']("seventh_column"), 25)], ["parent", "tool_bar"]])));
      self.$grab("main_stage").$box((new Map([["id", "list_panel"], ["width", 400], ["bottom", 50], ["top", 0], ["height", "auto"], ["left", 0], ["color", $$('LyricsStyle').$colors()['$[]']("background")], ["depth", 10], ["overflow", "auto"], ["display", "none"], ["attach", "lyrics_support"]])));
      list_title_bar = self.$grab("list_title_bar").$box((new Map([["id", "list_title_bar"], ["width", 400], ["height", 39], ["top", 0], ["left", 0], ["color", $$('LyricsStyle').$colors()['$[]']("primary")], ["attach", "list_panel"], ["shadow", $$('LyricsStyle').$decorations()['$[]']("shadow")]])));
      self.$grab("list_title_bar").$box((new Map([["id", "list_bottom_bar"], ["width", 400], ["height", 39], ["top", "auto"], ["bottom", 0], ["left", 0], ["color", $$('LyricsStyle').$colors()['$[]']("primary")], ["attach", "list_panel"], ["shadow", $$('LyricsStyle').$decorations()['$[]']("shadow")]])));
      ...
      self.$grab("main_stage").$box((new Map([["id", "list_container"], ["width", 380], ["height", "auto"], ["top", 39], ["bottom", 39], ["left", 10], ["overflow", "auto"], ["color", (new Map([["alpha", 0]]))], ["attach", "list_panel"]])));
      add_song = self.$button((new Map([["label", "new"], ["id", "add_song_to_list"], ["top", "auto"], ["bottom", 3], ["left", 10], ["parent", "list_bottom_bar"]])));
      save_list = self.$button((new Map([["label", "Save"], ["id", "save_list"], ["top", "auto"], ["bottom", 3], ["left", "auto"], ["right", 10], ["parent", "list_bottom_bar"]])));
    ...
    $def(self, '$refresh_song_list', function $$refresh_song_list() {
      ...
      sorted_keys = $send(current_list.$keys(), 'sort_by', [], function $$5(k){
        ...
        return k.$to_i();});
      top_position = 10;
      return $send(sorted_keys, 'each', [], function $$6(key){var self = $$6.$$s == null ? this : $$6.$$s, item = nil, song_item = nil, load_button = nil, delete_button = nil;
        ...
        song_item = self.$grab("main_stage").$box((new Map([["id", "song_item_" + (key)], ["width", 360], ["height", 50], ["top", top_position], ["left", 0], ["smooth", 6], ["color", $$('LyricsStyle').$colors()['$[]']("primary")], ["attach", "list_container"]])));
        ...
        $send(load_button, 'touch', [true], function $$7(){var self = $$7.$$s == null ? this : $$7.$$s, title_to_load = nil, new_key = nil;
          ...
          if ($truthy(new_key)) {
            self.$load_song_from_list(new_key)
          };
          return self.$grab("list_panel").$display("none");}, {$$s: self});
        $send(song_item, 'touch', [true], function $$8(){var self = $$8.$$s == null ? this : $$8.$$s, title_to_load = nil, new_key = nil;
          ...
          return self.$grab("list_panel").$display("none");}, {$$s: self});
        $send(delete_button, 'touch', [true], function $$9(){var self = $$9.$$s == null ? this : $$9.$$s, title_to_delete = nil, new_key = nil;
        ...
        $send(self.$grab("order_" + (key)), 'keyboard', ["down"], function $$10(native_event){var self = $$10.$$s == null ? this : $$10.$$s, event = nil, title_to_reorder = nil, new_key = nil, new_order = nil;
    ...
    $def(self, '$find_song_key_by_title', function $$find_song_key_by_title(title) {try { var $t_return = $thrower('return'); 
      ...
      $send(self.list, 'each', [], function $$11(key, item){
        
        if (key == null) key = nil;
        if (item == null) item = nil;
        if (($truthy(item) && ($eqeq(item['$[]']("title").$to_s(), title)))) {
          $t_return.$throw(key, $$11.$$is_lambda)
        } else {
          return nil
        };}, {$$ret: $t_return});
      return nil;} catch($e) {
    ...
    $def(self, '$load_song_from_list', function $$load_song_from_list(key) {try { 
      var $a, self = this, song_data = nil, lyrics = nil, raw_text = nil;
      ...
      lyrics = (function() { try {
        return ($a = song_data['$[]']("lyrics"), typeof Opal.compile === 'function' ? eval(Opal.compile($a, {scope_variables: ["song_data", "lyrics", "key"], arity_check: false, file: '(eval)', eval: true})) : self.$eval($a))
      } catch ($err) {
        if (Opal.rescue($err, [$$('StandardError')])) {
          try {
            return (new Map())
      ...
      if ($truthy(self.$grab("main_line"))) {
        self.$grab("main_line").$content(lyrics)
      };
      $send(Opal.Range.$new(1,self.number_of_lines, true), 'each', [], function $$12(index){var self = $$12.$$s == null ? this : $$12.$$s;
    ...
    $def(self, '$reorder_all_songs', function $$reorder_all_songs() {
      var self = this, sorted_items = nil, key_mapping = nil;

      
      sorted_items = $send(self.list.$to_a(), 'sort_by', [], function $$13(k, _){
        
        if (k == null) k = nil;
        if (_ == null) _ = nil;
        return k.$to_i();});
      $send(sorted_items, 'map', [], function $$14(k, _){
        
        if (k == null) k = nil;
        if (_ == null) _ = nil;
        return k;});
      key_mapping = (new Map());
      $send(sorted_items, 'each_with_index', [], function $$15($mlhs_tmp1, index){var $a, $b, self = $$15.$$s == null ? this : $$15.$$s, old_key = nil, item = nil, new_key = nil;
        if (self.list == null) self.list = nil;
    ...
    $def(self, '$add_current_song_to_list', function $$add_current_song_to_list(song_nb) {
      ...
      current_lyrics = (function() { try {
        return self.$grab("main_line").$content().$to_s()
      } catch ($err) {
        if (Opal.rescue($err, [$$('StandardError')])) {
          try {
            return "{}"
...
Opal.queue(function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('grab,display,delete,is_a?,to_json,setItem,localStorage,global,getItem,length,times,key,<<,box,[],colors,identity_generator,dimensions,button_style,text,text_style,split,each_with_index,*,decorations,touch,data,alter_lyric_event,update_song_listing,audio,new,element,init_audio,new_song,initialize_list_manager,list_all_files_in_localstorage,last,load_file,to_s,load_strategy,hide_all_panels,init_lyrix');
  
  
  $def(self, '$hide_all_panels', function $$hide_all_panels() {
    var self = this;

    
    if ($truthy(self.$grab("import_module"))) {
      self.$grab("import_module").$display("none")
    };
    if ($truthy(self.$grab("list_panel"))) {
      self.$grab("list_panel").$display("none")
    };
    if ($truthy(self.$grab("lyrics_editor_container"))) {
      self.$grab("lyrics_editor_container").$delete((new Map([["recursive", true]])))
  ...
  $def(self, '$save_file_to_db', function $$save_file_to_db(file_name, content_to_save) {
  ...
  $def(self, '$load_file', function $$load_file(file_name) {
    ...
    try {
      return $$('JS').$global().$localStorage().$getItem(file_name)
    } catch ($err) {
  ...
  (function($base, $super) {
    ...
    return $def(self, '$audio_length', function $$audio_length(audio_object) {
  ...
  $def(self, '$parse_song_lyrics', function $$parse_song_lyrics(song) {
    ...
    return $send(song_lines, 'each_with_index', [], function $$2(line_found, index){var self = $$2.$$s == null ? this : $$2.$$s, new_id = nil, line_support = nil;
      ...
      line_support = self.$grab("importer_support").$box((new Map([["id", new_id], ["width", 399], ["height", 30], ["top", $rb_times(index, 33)], ["left", 3], ["color", $$('LyricsStyle').$colors()['$[]']("container_bg")], ["smooth", $$('LyricsStyle').$decorations()['$[]']("standard_smooth")]])));
      line_support.$text((new Map([["data", line_found], ["id", "" + (new_id) + "_text"], ["top", 1], ["left", 1], ["position", "absolute"], ["width", 399]])));
      return $send(line_support, 'touch', ["down"], function $$3(){var self = $$3.$$s == null ? this : $$3.$$s, lyrics = nil;
  ...
  $def(self, '$init_lyrix', function $$init_lyrix(lyrics_content, song_path) {
    var self = this, lyr = nil, import_drag = nil, result = nil, file = nil, file_content = nil, current_lyricist = nil, list_to_load = nil;
  ...
  return self.$init_lyrix((new Map([[0, "hi"], [233, "jeezs"]])), "medias/audios/Alive.mp3");
});
