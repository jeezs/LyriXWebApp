...
Opal.modules["lyricist_buttons"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    return $def(self, '$build_control_buttons', function $$build_control_buttons() {
      ...
      $send(save_song, 'touch', [true], function $$24(){var self = $$24.$$s == null ? this : $$24.$$s, lyrics = nil, content_to_save = nil, list_tile = nil;
        ...
        return self.$save_file(list_tile, content_to_save);}, {$$s: self});
...
Opal.queue(function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('box,[],colors,length,play,pause,identity_generator,dimensions,grab,button_style,text,text_style,timer,[]=,content,data,blink,split,each_with_index,*,decorations,touch,alter_lyric_event,update_song_listing,audio,display,new,element,init_audio,new_song,initialize_list_manager,init_lyrix');
