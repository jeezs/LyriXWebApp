...
Opal.modules["lyricist_base"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $klass = Opal.klass, $truthy = Opal.truthy, $def = Opal.def, $eqeq = Opal.eqeq, $send = Opal.send, $to_ary = Opal.to_ary, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil;

  Opal.add_stubs('attr_accessor,build_ui,new_song,audio,grab,top,==,left,right,[],dimensions,width,height,depth=,depth,bottom,content,last,to_a,refresh_viewer');
  return (function($base, $super, $parent_nesting) {
    ...
    $def(self, '$initialize', function $$initialize(content) {
      ...
      self.original_number_of_lines = 16;
...
Opal.modules["lyricist_ui"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    $def(self, '$build_timeline_slider', function $$build_timeline_slider() {
      ...
      $send(self.$grab("main_stage"), 'slider', [$$('LyricsStyle').$slider_style((new Map([["id", "timeline_slider"], ["attach", "bottom_bar"], ["range", (new Map([["color", "orange"]]))], ["min", 0], ["max", self.length], ["width", $$('LyricsStyle').$dimensions()['$[]']("slider_width")], ["value", 0], ["height", $$('LyricsStyle').$dimensions()['$[]']("slider_height")], ["left", $rb_plus($$('LyricsStyle').$dimensions()['$[]']("margin"), 33)], ["tag", []], ["top", $$('LyricsStyle').$dimensions()['$[]']("margin")], ["color", "orange"], ["cursor", (new Map([["color", "orange"], ["width", 25], ["height", 25]]))]])))], function $$3(value){var self = $$3.$$s == null ? this : $$3.$$s, lyrics = nil, counter = nil;
...
Opal.modules["lyricist_buttons"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    $def(self, '$stop_lyrics', function $$stop_lyrics() {
      var self = this, counter = nil, lyrics = nil;
    ...
    $def(self, '$play_lyrics', function $$play_lyrics() {
      ...
      if ($truthy(self.playing)) {
        ...
        self.$play_audio(self.audio_object, $rb_divide(self.actual_position, 1000));
        prev_length = self.length;
        $send(counter, 'timer', [(new Map([["end", $$$($$('Float'), 'INFINITY')]]))], function $$7(value){var self = $$7.$$s == null ? this : $$7.$$s, lyrics = nil;
          if (self.length == null) self.length = nil;
          if (self.record == null) self.record = nil;
    ...
    return $def(self, '$build_control_buttons', function $$build_control_buttons() {
      ...
      $send(prev_word, 'touch', [true], function $$17(){var self = $$17.$$s == null ? this : $$17.$$s, lyrics = nil, counter = nil, current_position = nil, sorted_keys = nil, prev_index = nil, prev_position = nil;
        ...
        prev_index = $send(sorted_keys, 'rindex', [], function $$18(key){
      ...
      $send(next_word, 'touch', [true], function $$19(){var self = $$19.$$s == null ? this : $$19.$$s, lyrics = nil, counter = nil, current_position = nil, sorted_keys = nil, next_index = nil, next_position = nil, last_position = nil;
        ...
        current_position = counter.$timer()['$[]']("position");
        sorted_keys = lyrics.$content().$keys().$sort();
        next_index = $send(sorted_keys, 'find_index', [], function $$20(key){
...
Opal.modules["lyricist_core"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $klass = Opal.klass, $truthy = Opal.truthy, $send = Opal.send, $rb_le = Opal.rb_le, $thrower = Opal.thrower, $rb_gt = Opal.rb_gt, $rb_plus = Opal.rb_plus, $rb_ge = Opal.rb_ge, $def = Opal.def, $eqeq = Opal.eqeq, $neqeq = Opal.neqeq, $rb_times = Opal.rb_times, $rb_divide = Opal.rb_divide, $range = Opal.range, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil;

  Opal.add_stubs('empty?,sort,keys,reverse_each,<=,nil?,first,<<,[],>,index,each,+,>=,size,==,content,grab,!=,data,content=,stop_lyrics,colors,positions,dimensions,respond_to?,update,send,each_with_index,*,/,merge,text,[]=,timer,closest_values,format_lyrics,delete,build_timeline_slider,value,rebuild_timeline_slider,clear,cleanup_cache,wait,play_lyrics,eval,call,puts,last');
  return (function($base, $super, $parent_nesting) {
    var self = $klass($base, $super, 'Lyricist');
...
Opal.queue(function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('grab,display,delete,is_a?,to_json,setItem,localStorage,global,getItem,length,times,key,<<,box,[],colors,play,pause,identity_generator,dimensions,button_style,text,text_style,timer,[]=,content,data,blink,split,each_with_index,*,decorations,touch,alter_lyric_event,update_song_listing,audio,new,element,init_audio,new_song,initialize_list_manager,list_all_files_in_localstorage,last,load_file,to_s,load_strategy,hide_all_panels,init_lyrix');
