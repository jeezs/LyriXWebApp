...
Opal.modules["lyricist_ui"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    $def(self, '$build_song_support', function $$build_song_support() {
      ...
      self.$grab("view").$box((new Map([["id", "import_module"], ["top", $$('LyricsStyle').$dimensions()['$[]']("tool_bar_height")], ["left", "auto"], ["right", 9], ["width", 399], ["bottom", 50], ["height", "auto"], ["smooth", $$('LyricsStyle').$decorations()['$[]']("standard_smooth")], ["color", $$('LyricsStyle').$colors()['$[]']("container_bg")], ["shadow", $$('LyricsStyle').$decorations()['$[]']("shadow")], ["depth", 2]])));
    ...
    return $def(self, '$setup_lyrics_events', function $$setup_lyrics_events() {try { 
      var self = this, lyrics = nil;

      
      lyrics = self.$grab("lyric_viewer");
      return $send(lyrics, 'keyboard', ["down"], function $$7(native_event){var $a, $b, self = $$7.$$s == null ? this : $$7.$$s, event = nil, current_song = nil, current_hash = nil, updated_lyrics = nil;
        if (self.list == null) self.list = nil;
        if (self.title == null) self.title = nil;
        if (self.lyrics == null) self.lyrics = nil;
        if (self.actual_position == null) self.actual_position = nil;
        ...
        if ($eqeq(event['$[]']("keyCode").$to_s(), "13")) {
          ...
          self.$puts("OK 7 case song: " + (current_song));
          current_hash = ($a = self.list['$[]'](current_song)['$[]']("lyrics"), typeof Opal.compile === 'function' ? eval(Opal.compile($a, {scope_variables: ["event", "current_song", "current_hash", "native_event", "lyrics"], arity_check: false, file: '(eval)', eval: true})) : self.$eval($a));
          self.$alert("current_hash: " + (current_hash));
          self.$alert("current_lyrics : " + (self.list));
          self.$alert("@lyrics[@actual_position]: " + (self.lyrics['$[]'](self.actual_position)));
          updated_lyrics = ($b = [self.actual_position, self.lyrics['$[]'](self.actual_position)], $send(current_hash, '[]=', $b), $b[$b.length - 1]);
          updated_lyrics = updated_lyrics.$to_s();
          self.list['$[]'](current_song)['$[]=']("lyrics", updated_lyrics);
          return self.$alert("current_lyrics : " + (self.list));
        } else {
          return nil
        };}, {$$s: self});} catch($e) {
...
Opal.modules["lyricist_buttons"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    $def(self, '$load_strategy', function $$load_strategy(val) {try { 
      var $a, $b, self = this, filename = nil, content = nil, current_lyricist = nil, audio_path = nil, file_to_load = nil, lyrics = nil, title = nil, raw = nil, current_lyrix = nil;
      ...
      switch ($$('File').$extname(filename).$downcase().valueOf()) {
        ...
        case ".txt":
          ...
          return (self.imported_lyrics = val['$[]']("content"));
        case ".lrx":
    ...
    return $def(self, '$build_control_buttons', function $$build_control_buttons() {
      ...
      $send(view_importer, 'touch', [true], function $$12(){var self = $$12.$$s == null ? this : $$12.$$s, import_drag = nil;
        ...
        if ($eqeq(import_drag.$display(), "none")) {
          ...
          if ($truthy(self.$grab("lyrics_editor_container"))) {
            return self.$grab("lyrics_editor_container").$delete((new Map([["recursive", true]])))
          } else {
            return nil
          };
        } else {
      ...
      $send(edit_import, 'touch', [true], function $$22(val){var self = $$22.$$s == null ? this : $$22.$$s, text_to_edit = nil;
        ...
        if ($truthy(self.edit_lyrics_mode)) {
          ...
          self.$grab("importer_support").$clear(true);
          self.$parse_song_lyrics(self.imported_lyrics);
          return (self.edit_lyrics_mode = false);
        } else {
          ...
          return (self.edit_lyrics_mode = true);
        };}, {$$s: self});
      save_song = self.$button((new Map([["label", "save"], ["id", "save"], ["top", $$('LyricsStyle').$dimensions()['$[]']("margin")], ["left", 525], ["parent", "bottom_bar"]])));
      $send(save_song, 'touch', [true], function $$24(){var self = $$24.$$s == null ? this : $$24.$$s, lyrics = nil, content_to_save = nil;
        ...
        content_to_save = (new Map([["lyrics", lyrics], ["song", self.audio_path], ["title", self.title], ["raw", self.imported_lyrics]]));
      ...
      $send(load_song, 'import', [true], function $$25(val){var self = $$25.$$s == null ? this : $$25.$$s, current_lyricist = nil;
      ...
      return $send(titesong, 'keyboard', ["down"], function $$26(native_event){var self = $$26.$$s == null ? this : $$26.$$s, event = nil, title = nil;
...
Opal.modules["lyricist_editor"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('box,grab,container_style,text,text_style,[],dimensions,colors,to_h,sort,content,each_with_index,+,*,line_container_style,to_sym,to_s,setup_edit_line_events,build_update_button,build_delete_button,build_add_line_button,private,keyboard,Native,==,alert,class,preventDefault,to_i,data,!=,delete,[]=,blink,timer,update_lyrics,max,keys,>,full_refresh_viewer,action_button_style,touch,left,top,show_lyrics_editor,size,show_add_dialog,build_dialog_buttons,!,empty?');
  return (function($base, $super, $parent_nesting) {
    var self = $klass($base, $super, 'Lyricist');
    ...
    $def(self, '$setup_edit_line_events', function $$setup_edit_line_events(line_container, timecode_field, text_field, timecode, lyrics) {
      ...
      $send(timecode_field, 'keyboard', ["dowm"], function $$2(native_event){var self = $$2.$$s == null ? this : $$2.$$s, event = nil, old_timecode = nil, new_timecode = nil, new_text = nil, counter = nil, current_position = nil, max_timecode = nil, prev_position = nil;
        ...
        if ($eqeq(event['$[]']("keyCode").$to_s(), "13")) {
          ...
          self.$alert("OK 2 case " + (self.$class()));
          event.$preventDefault();
      ...
      return $send(text_field, 'keyboard', ["dowm"], function $$3(native_event){var self = $$3.$$s == null ? this : $$3.$$s, event = nil, old_timecode = nil, new_timecode = nil, new_text = nil, counter = nil, current_position = nil, max_timecode = nil, prev_position = nil;
        ...
        if ($eqeq(event['$[]']("keyCode").$to_s(), "13")) {
          ...
          self.$alert("OK 3 case " + (self.$class()));
          event.$preventDefault();
          old_timecode = timecode;
          new_timecode = timecode_field.$data().$to_i();
          new_text = text_field.$data();
    ...
    $def(self, '$build_update_button', function $$build_update_button(line_container, timecode, timecode_field, text_field, lyrics) {
      ...
      $send(update_button, 'touch', [true], function $$4(){var self = $$4.$$s == null ? this : $$4.$$s, old_timecode = nil, new_timecode = nil, new_text = nil, counter = nil, current_position = nil, max_timecode = nil, prev_position = nil;
        ...
        self.$alert("OK 4 case " + (self.$class()));
        old_timecode = timecode;
        new_timecode = timecode_field.$data().$to_i();
        new_text = text_field.$data();
        if ($neqeq(new_timecode, old_timecode)) {
    ...
    $def(self, '$build_delete_button', function $$build_delete_button(line_container, editor_container, timecode, lyrics) {
      ...
      $send(delete_button, 'touch', [true], function $$5(){var self = $$5.$$s == null ? this : $$5.$$s, prev_left = nil, prev_top = nil, counter = nil, current_position = nil;
        ...
        self.$update_lyrics(current_position, lyrics, counter);
        self.$full_refresh_viewer(current_position);
        return self.$alert("OK 5 case " + (self.$class()));}, {$$s: self});
    ...
    return $def(self, '$build_dialog_buttons', function $$build_dialog_buttons(dialog_container, new_timecode_field, new_text_field, editor_container, lyrics) {
      ...
      $send(confirm_button, 'touch', [true], function $$9(){var self = $$9.$$s == null ? this : $$9.$$s, prev_left = nil, prev_top = nil, new_timecode = nil, new_text = nil, counter = nil, current_position = nil;
        ...
        self.$alert("OK 6 case " + (self.$class()));
        prev_left = editor_container.$left();
        prev_top = editor_container.$top();
...
Opal.modules["list"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    $def(self, '$build_list_manager', function $$build_list_manager() {
      ...
      self.$grab("main_stage").$box((new Map([["id", "list_panel"], ["width", 400], ["height", 500], ["top", 50], ["left", 150], ["color", $$('LyricsStyle').$colors()['$[]']("background")], ["border", (new Map([["color", $$('LyricsStyle').$colors()['$[]']("primary")], ["width", 2]]))], ["depth", 10], ["overflow", "auto"], ["display", "none"], ["attach", "tool_bar"]])));
      ...
      list_container = self.$grab("main_stage").$box((new Map([["id", "list_container"], ["width", 380], ["height", 400], ["top", 50], ["left", 10], ["color", $$('LyricsStyle').$colors()['$[]']("background")], ["attach", "list_panel"]])));
    ...
    $def(self, '$refresh_song_list', function $$refresh_song_list() {
      ...
      return $send(sorted_keys, 'each', [], function $$7(key){var self = $$7.$$s == null ? this : $$7.$$s, item = nil, item_container = nil, order_input = nil, load_button = nil, delete_button = nil;
        ...
        item_container = self.$grab("main_stage").$box((new Map([["id", "song_item_" + (key)], ["width", 360], ["height", 50], ["top", top_position], ["left", 0], ["smooth", 6], ["color", $$('LyricsStyle').$colors()['$[]']("primary")], ["attach", "list_container"]])));
        order_input = self.$grab("main_stage").$text((new Map([["data", key.$to_s()], ["id", "order_" + (key)], ["height", 30], ["position", "absolute"], ["top", 10], ["left", 10], ["edit", true], ["color", "lightgray"], ["attach", "song_item_" + (key)]])));
        ...
        $send(delete_button, 'touch', [true], function $$9(){var self = $$9.$$s == null ? this : $$9.$$s;
          ...
          return $send(self, 'wait', [0.5], function $$10(){var self = $$10.$$s == null ? this : $$10.$$s;

            return self.$refresh_song_list()}, {$$s: self});}, {$$s: self});
        $send(self.$grab("order_" + (key)), 'keyboard', ["down"], function $$11(native_event){var self = $$11.$$s == null ? this : $$11.$$s, event = nil, new_order = nil;
    ...
    $def(self, '$reorder_all_songs', function $$reorder_all_songs() {
      ...
      sorted_items = $send(self.list.$to_a(), 'sort_by', [], function $$12(k, _){
        ...
        return k.$to_i();});
      self.list = (new Map());
      return $send(sorted_items, 'each_with_index', [], function $$13($mlhs_tmp1, index){var $a, $b, self = $$13.$$s == null ? this : $$13.$$s, _ = nil, item = nil;
        if (self.list == null) self.list = nil;
...
Opal.queue(function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('box,length,play,pause,[],identity_generator,dimensions,colors,grab,button_style,text,text_style,timer,[]=,content,data,blink,split,each_with_index,*,decorations,touch,alert,class,alter_lyric_event,audio,display,new,element,init_audio,new_song,initialize_list_manager,init_lyrix');
  ...
  self.$box((new Map([["id", "main_stage"], ["width", "100%"], ["height", "100%"], ["overflow", "hidden"]])));
  (function($base, $super) {
  ...
  $def(self, '$parse_song_lyrics', function $$parse_song_lyrics(song) {
    ...
    return $send(song_lines, 'each_with_index', [], function $$1(line_found, index){var self = $$1.$$s == null ? this : $$1.$$s, new_id = nil, line_support = nil;
      ...
      return $send(line_support, 'touch', [true], function $$2(){var self = $$2.$$s == null ? this : $$2.$$s, lyrics = nil;
        ...
        self.$alert("OK 1 case " + (self.$class()));
