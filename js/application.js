Opal.modules["lyrics_style"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return (function($base, $super) {
    ...
    $defs(self, '$container_style', function $$container_style(options) {
      ...
      if (options == null) options = (new Map());
      style = (new Map([["width", self.$dimensions()['$[]']("container_width")], ["height", self.$dimensions()['$[]']("container_height")], ["smooth", self.$decorations()['$[]']("container_smooth")]]));
      return style.$merge(options);
    }, -1);
...
Opal.modules["lyricist_base"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $klass = Opal.klass, $truthy = Opal.truthy, $def = Opal.def, $eqeq = Opal.eqeq, $send = Opal.send, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil;

  Opal.add_stubs('attr_accessor,build_ui,new_song,audio,grab,top,==,left,right,[],dimensions,width,height,depth=,depth,bottom,content,refresh_viewer');
...
Opal.modules["lyricist_ui"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $klass = Opal.klass, $def = Opal.def, $send = Opal.send, $rb_plus = Opal.rb_plus, $truthy = Opal.truthy, $rb_divide = Opal.rb_divide, $rb_ge = Opal.rb_ge, $rb_lt = Opal.rb_lt, $eqeq = Opal.eqeq, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, $$$ = Opal.$$$;

  Opal.add_stubs('build_tool_bar,build_song_support,build_control_buttons,build_lyrics_viewer,build_timeline_slider,button,[],positions,dimensions,overflow,grab,text,colors,box,touch,fullscreen,timer,setup_lyrics_events,decorations,shadow,importer,data,load_strategy,slider,slider_style,+,update_lyrics,stop_audio,play_audio,/,to_i,>=,<,value,hide_all_panels,find_key_by_title,delete_song_from_list,add_current_song_to_list,refresh_song_list,keyboard,Native,==,to_s,content,preventDefault,alter_lyric_event,update_song_listing');
  return (function($base, $super, $parent_nesting) {
    var self = $klass($base, $super, 'Lyricist');
    ...
    $def(self, '$build_timeline_slider', function $$build_timeline_slider() {
      ...
      $send(self.$grab("main_stage"), 'slider', [$$('LyricsStyle').$slider_style((new Map([["id", "timeline_slider"], ["attach", "bottom_bar"], ["range", (new Map([["color", "orange"]]))], ["min", 0], ["max", self.length], ["width", $$('LyricsStyle').$dimensions()['$[]']("slider_width")], ["value", 0], ["height", $$('LyricsStyle').$dimensions()['$[]']("slider_height")], ["left", $rb_plus($$('LyricsStyle').$dimensions()['$[]']("margin"), 33)], ["tag", []], ["top", $$('LyricsStyle').$dimensions()['$[]']("margin")], ["color", "orange"], ["cursor", (new Map([["color", "orange"], ["width", 25], ["height", 25]]))]])))], function $$3(value){var self = $$3.$$s == null ? this : $$3.$$s, lyrics = nil;

        
        if (value == null) value = nil;
        lyrics = self.$grab("lyric_viewer");
        return self.$update_lyrics(value, lyrics);}, {$$s: self});
    ...
    return $def(self, '$setup_lyrics_events', function $$setup_lyrics_events() {
      ...
      lyrics = self.$grab("lyric_viewer");
      return $send(lyrics, 'keyboard', ["down"], function $$11(native_event){var self = $$11.$$s == null ? this : $$11.$$s, event = nil;
...
Opal.modules["lyricist_buttons"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    $def(self, '$stop_lyrics', function $$stop_lyrics() {
      ...
      lyrics = self.$grab("lyric_viewer");
      self.$update_lyrics(0, lyrics, self.$counter());
    ...
    $def(self, '$play_audio', function $$play_audio(audio_object, actual_position) {
      var self = this, current_lyricist = nil, counter = nil, lyrics = nil, slider = nil;

      
      current_lyricist = self.$grab("the_lyricist").$data();
      self.length = current_lyricist.$instance_variable_get("@length");
      self.record = current_lyricist.$instance_variable_get("@record");
      self.actual_position = current_lyricist.$instance_variable_get("@actual_position");
      counter = self.$grab("counter");
      lyrics = self.$grab("lyric_viewer");
    ...
    return $def(self, '$build_control_buttons', function $$build_control_buttons() {
      var self = this, play = nil, edit_lyrics = nil, erase = nil, view_importer = nil, record = nil, clear = nil, stop = nil, prev_word = nil, next_word = nil, import_lyrics = nil, save_edited_text = nil, edit_import = nil, save_song = nil, load_prev_song = nil, load_next_song = nil, load_song = nil, titesong = nil;
      ...
      $send(prev_word, 'touch', [true], function $$17(){var self = $$17.$$s == null ? this : $$17.$$s, lyrics = nil, sorted_keys = nil, prev_index = nil, prev_position = nil;
      ...
      $send(next_word, 'touch', [true], function $$19(){var self = $$19.$$s == null ? this : $$19.$$s, lyrics = nil, sorted_keys = nil, next_index = nil, next_position = nil, last_position = nil;

        
        lyrics = self.$grab("lyric_viewer");
        sorted_keys = lyrics.$content().$keys().$sort();
        next_index = $send(sorted_keys, 'find_index', [], function $$20(key){var self = $$20.$$s == null ? this : $$20.$$s;
          if (self.actual_position == null) self.actual_position = nil;
      ...
      $send(import_lyrics, 'import', [true], function $$21(val){var self = $$21.$$s == null ? this : $$21.$$s, current_lyrix = nil;
      ...
      $send(save_edited_text, 'touch', [true], function $$22(val){var self = $$22.$$s == null ? this : $$22.$$s;
      ...
      $send(edit_import, 'touch', [true], function $$23(val){var self = $$23.$$s == null ? this : $$23.$$s, text_to_edit = nil;
        ...
        if ($truthy(self.edit_lyrics_mode)) {
          ...
          $send(text_to_edit, 'keyboard', ["down"], function $$24(native_event){var self = $$24.$$s == null ? this : $$24.$$s;
      ...
      $send(save_song, 'touch', [true], function $$25(){var self = $$25.$$s == null ? this : $$25.$$s, content_to_save = nil, list_tile = nil;
      ...
      $send(load_prev_song, 'touch', [true], function $$26(){var self = $$26.$$s == null ? this : $$26.$$s;
      ...
      $send(load_next_song, 'touch', [true], function $$27(){var self = $$27.$$s == null ? this : $$27.$$s;
      ...
      $send(load_song, 'touch', [true], function $$28(){var self = $$28.$$s == null ? this : $$28.$$s, load_file = nil, result = nil;
        ...
        if ($truthy(self.$grab("loader"))) {
          ...
          $send(load_file, 'import', [true], function $$29(val){var self = $$29.$$s == null ? this : $$29.$$s, current_lyricist = nil;
          ...
          return $send(result['$[]']("files"), 'each_with_index', [], function $$30(file, index){var self = $$30.$$s == null ? this : $$30.$$s, list_f = nil;
            ...
            return $send(list_f, 'touch', [true], function $$31(){var self = $$31.$$s == null ? this : $$31.$$s, file_content = nil, current_lyricist = nil, list_to_load = nil;
      ...
      return $send(titesong, 'keyboard', ["down"], function $$32(native_event){var self = $$32.$$s == null ? this : $$32.$$s, event = nil, title = nil;
...
Opal.modules["lyricist_editor"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    $def(self, '$show_lyrics_editor', function $$show_lyrics_editor(left_f, top_f) {
      ...
      $send(sorted_lyrics, 'each_with_index', [], function $$2($mlhs_tmp1, index){var $a, $b, self = $$2.$$s == null ? this : $$2.$$s, timecode = nil, text = nil, y_position = nil, line_container = nil, timecode_field = nil, text_field = nil, update_button = nil, delete_button = nil;
    ...
    $def(self, '$setup_edit_line_events', function $$setup_edit_line_events(line_container, timecode_field, text_field, timecode, lyrics) {
      ...
      $send(timecode_field, 'keyboard', ["dowm"], function $$3(native_event){var self = $$3.$$s == null ? this : $$3.$$s, event = nil, old_timecode = nil, new_timecode = nil, new_text = nil, counter = nil, current_position = nil, max_timecode = nil, prev_position = nil;
        if (self.actual_position == null) self.actual_position = nil;
...
Opal.modules["lyricist_core"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $klass = Opal.klass, $truthy = Opal.truthy, $send = Opal.send, $rb_le = Opal.rb_le, $thrower = Opal.thrower, $rb_gt = Opal.rb_gt, $rb_plus = Opal.rb_plus, $rb_ge = Opal.rb_ge, $def = Opal.def, $eqeq = Opal.eqeq, $neqeq = Opal.neqeq, $rb_times = Opal.rb_times, $range = Opal.range, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil;

  Opal.add_stubs('empty?,sort,keys,reverse_each,<=,nil?,first,<<,[],>,index,each,+,>=,size,==,content,grab,!=,data,content=,stop_lyrics,colors,positions,dimensions,respond_to?,update,send,each_with_index,*,merge,text,closest_values,format_lyrics,delete,build_timeline_slider,value,rebuild_timeline_slider,clear,cleanup_cache,wait,play_lyrics,eval,call,puts,last');
  return (function($base, $super, $parent_nesting) {
    var self = $klass($base, $super, 'Lyricist');

    var $nesting = [self].concat($parent_nesting), $$ = Opal.$r($nesting), $proto = self.$$prototype;

    $proto.playing = $proto.number_of_lines = $proto.length = $proto.lyrics = $proto.default_length = nil;
    ...
    $def(self, '$reset_lyrics_system', function $$reset_lyrics_system() {
      ...
      if ($truthy(self.playing)) {
        ...
        self.$stop_lyrics();
        return $send(self, 'wait', [0.5], function $$7(){var self = $$7.$$s == null ? this : $$7.$$s;
    ...
    return $def(self, '$inspect_lyrics_content', function $$inspect_lyrics_content() {
      ...
      if (($truthy(content) && ($truthy($rb_gt(content.$keys().$size(), 0))))) {
        ...
        self.$puts("=== CONTENU DES PAROLES ===");
        self.$puts("Nombre de timecodes: " + (sorted_keys.$size()));
        self.$puts("Premier timecode: " + (sorted_keys.$first()));
        self.$puts("Dernier timecode: " + (sorted_keys.$last()));
        self.$puts("Premiers timecodes:");
        $send(sorted_keys['$[]']($range(0, 4, false)), 'each', [], function $$8(key){var self = $$8.$$s == null ? this : $$8.$$s;

          
          if (key == null) key = nil;
          return self.$puts("  " + (key) + ": " + (content['$[]'](key)));}, {$$s: self});
        self.$puts("Derniers timecodes:");
        $send(sorted_keys['$[]']($range(-5, -1, false)), 'each', [], function $$9(key){var self = $$9.$$s == null ? this : $$9.$$s;
        ...
        return self.$puts("Aucun contenu de paroles disponible")
      };
    });
  })($nesting[0], $$('Atome'), $nesting)
};
...
Opal.modules["list"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    $def(self, '$build_list_manager', function $$build_list_manager() {
      var self = this, list_button = nil, list_title_bar = nil, list_bottom_bar = nil, title_bar_list_text = nil, add_song = nil, save_list = nil;
      ...
      list_bottom_bar = self.$grab("list_title_bar").$box((new Map([["id", "list_bottom_bar"], ["width", 400], ["height", 39], ["top", "auto"], ["bottom", 0], ["left", 0], ["color", $$('LyricsStyle').$colors()['$[]']("primary")], ["attach", "list_panel"], ["shadow", $$('LyricsStyle').$decorations()['$[]']("shadow")]])));
    ...
    $def(self, '$reorder_all_songs', function $$reorder_all_songs() {
      ...
      sorted_items = $send(self.list.$to_a(), 'sort_by', [], function $$12(k, _){
        
        if (k == null) k = nil;
        if (_ == null) _ = nil;
        return k.$to_i();});
      old_keys = $send(sorted_items, 'map', [], function $$13(k, _){
        
        if (k == null) k = nil;
        if (_ == null) _ = nil;
        return k;});
      key_mapping = (new Map());
      $send(sorted_items, 'each_with_index', [], function $$14($mlhs_tmp1, index){var $a, $b, self = $$14.$$s == null ? this : $$14.$$s, old_key = nil, item = nil, new_key = nil;
        if (self.list == null) self.list = nil;
...
Opal.queue(function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('grab,display,delete,is_a?,to_json,setItem,localStorage,global,getItem,length,times,key,<<,box,[],colors,identity_generator,dimensions,button_style,text,text_style,[]=,content,data,blink,split,each_with_index,*,decorations,touch,alter_lyric_event,update_song_listing,audio,new,element,init_audio,new_song,initialize_list_manager,list_all_files_in_localstorage,last,load_file,to_s,load_strategy,hide_all_panels,init_lyrix');
  ...
  $def(self, '$alter_lyric_event', function $$alter_lyric_event() {
    ...
    lyrics = self.$grab("lyric_viewer");
    lyrics.$content()['$[]='](self.actual_position, lyrics.$data());
