...
Opal.modules["lyricist_ui"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $klass = Opal.klass, $def = Opal.def, $send = Opal.send, $eqeq = Opal.eqeq, $rb_plus = Opal.rb_plus, $truthy = Opal.truthy, $rb_divide = Opal.rb_divide, $rb_ge = Opal.rb_ge, $rb_lt = Opal.rb_lt, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, $$$ = Opal.$$$;
