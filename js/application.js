Opal.modules["lyrics_style"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return (function($base, $super) {
    ...
    $defs(self, '$container_style', function $$container_style(options) {
      ...
      if (options == null) options = (new Map());
      style = (new Map([["width", self.$dimensions()['$[]']("container_width")], ["height", self.$dimensions()['$[]']("container_height")], ["color", self.$colors()['$[]']("container_dark")], ["smooth", self.$decorations()['$[]']("container_smooth")], ["shadow", self.$decorations()['$[]']("container_shadow")], ["border", (new Map([["width", 1], ["color", self.$colors()['$[]']("accent")], ["alpha", 0.3]]))]]));
      return style.$merge(options);
    }, -1);
    ...
    $defs(self, '$line_container_style', function $$line_container_style(options) {
      ...
      if (options == null) options = (new Map());
      style = (new Map([["width", 520], ["height", 60], ["left", 15], ["color", self.$colors()['$[]']("container_medium")], ["smooth", self.$decorations()['$[]']("standard_smooth")], ["shadow", self.$decorations()['$[]']("standard_shadow")], ["border", (new Map([["width", 1], ["color", self.$colors()['$[]']("accent")], ["alpha", 0.2]]))]]));
      return style.$merge(options);
    }, -1);
    ...
    return $defs(self, '$build_button', function $$build_button(parent, options) {
      ...
      if (options == null) options = (new Map());
      default_options = (new Map([["color", self.$colors()['$[]']("primary")], ["width", self.$dimensions()['$[]']("standard_width")], ["height", self.$dimensions()['$[]']("button_height")], ["top", 0], ["left", 0], ["smooth", self.$decorations()['$[]']("button_smooth")], ["shadow", self.$decorations()['$[]']("button_shadow")], ["border", (new Map([["width", 1], ["color", self.$colors()['$[]']("accent")], ["alpha", 0.3]]))], ["label", ""], ["label_color", self.$colors()['$[]']("text_primary")], ["id", self.$identity_generator()]]));
      opts = default_options.$merge(options);
      button = parent.$box((new Map([["id", opts['$[]']("id")], ["width", opts['$[]']("width")], ["height", opts['$[]']("height")], ["top", opts['$[]']("top")], ["left", opts['$[]']("left")], ["color", opts['$[]']("color")], ["smooth", opts['$[]']("smooth")], ["border", opts['$[]']("border")]])));
...
Opal.modules["lyricist_ui"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    $def(self, '$build_lyrics_viewer', function $$build_lyrics_viewer() {
      ...
      base_text = "";
      lyrics_support = self.$grab("view").$box((new Map([["id", "lyrics_support"], ["width", "auto"], ["height", "auto"], ["top", $$('LyricsStyle').$dimensions()['$[]']("tool_bar_height")], ["left", 0], ["right", 0], ["bottom", 0], ["color", $$('LyricsStyle').$colors()['$[]']("container_bg")]])));
      ...
      $send(lyrics_support, 'touch', ["double"], function $$1(){var $a, top_f = nil;
    ...
    $def(self, '$build_song_support', function $$build_song_support() {
      ...
      self.$grab("view").$box((new Map([["id", "import_module"], ["top", $$('LyricsStyle').$dimensions()['$[]']("tool_bar_height")], ["left", "auto"], ["right", 9], ["width", 399], ["bottom", 50], ["height", "auto"], ["smooth", $$('LyricsStyle').$decorations()['$[]']("standard_smooth")], ["color", $$('LyricsStyle').$colors()['$[]']("container_bg")], ["drag", true], ["resize", true], ["depth", 2]])));
    ...
    $def(self, '$build_tool_bar', function $$build_tool_bar() {
      ...
      self.$grab("view").$box((new Map([["id", "tool_bar"], ["color", $$('LyricsStyle').$colors()['$[]']("container_bg")], ["shadow", $$('LyricsStyle').$decorations()['$[]']("standard_shadow")], ["top", 0], ["left", 0], ["right", 0], ["width", "auto"], ["height", $$('LyricsStyle').$dimensions()['$[]']("tool_bar_height")], ["opacity", 1], ["depth", 3]])));
      return self.$grab("view").$box((new Map([["id", "bottom_bar"], ["color", $$('LyricsStyle').$colors()['$[]']("container_bg")], ["shadow", $$('LyricsStyle').$decorations()['$[]']("standard_shadow")], ["top", "auto"], ["bottom", 0], ["left", 0], ["right", 0], ["width", "auto"], ["height", $$('LyricsStyle').$dimensions()['$[]']("tool_bar_height")], ["opacity", 1], ["depth", 3]])));
    });
...
Opal.modules["lyricist_buttons"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('box,grab,smooth,color,[],colors,shadow,decorations,center,touch,text,wait,data,size,-,/,load_song_from_list,play_lyrics,puts,alert,length,delete,stop_audio,timer,update_lyrics,build_timeline_slider,==,data=,to_s,+,to_i,find_key_by_title,<,loading_coundown,play_audio,>=,value,downcase,extname,init_audio,clear,parse_song_lyrics,display,clear_all,content,full_refresh_viewer,set_list,refresh_song_list,to_f,duration,>,call,setTimeout,global,wait_for_duration,%,rjust,path,*,button,dimensions,show_lyrics_editor,positions,edit,stop_lyrics,sort,keys,rindex,find_index,last,import,set_imported_lyrics,save_file,keyboard,load_strategy,Native,blink,preventDefault');
  return (function($base, $super, $parent_nesting) {
    var self = $klass($base, $super, 'Lyricist');
    ...
    $def(self, '$set_list', function $$set_list(filename, content) {try { 
      var $a, self = this, list_content = nil;

      
      list_content = ($a = content, typeof Opal.compile === 'function' ? eval(Opal.compile($a, {scope_variables: ["list_content", "filename", "content"], arity_check: false, file: '(eval)', eval: true})) : self.$eval($a));
    ...
    $def(self, '$loading_coundown', function $$loading_coundown(next_song) {
      ...
      return $send(self, 'wait', [3], function $$4(){var self = $$4.$$s == null ? this : $$4.$$s;
        ...
        if ($truthy(self.allow_loading)) {
          ...
          self.$puts(self.$puts("loading prevented"));
    ...
    $def(self, '$load_strategy', function $$load_strategy(val) {try { 
      var $a, $b, self = this, filename = nil, content = nil, current_lyricist = nil, audio_path = nil, file_to_load = nil, lyrics = nil, title = nil, current_lyrix = nil;
      ...
      switch ($$('File').$extname(filename).$downcase().valueOf()) {
        ...
        case ".lrx":
          ...
          file_to_load = ($a = content, typeof Opal.compile === 'function' ? eval(Opal.compile($a, {scope_variables: ["filename", "content", "current_lyricist", "audio_path", "file_to_load", "val"], arity_check: false, file: '(eval)', eval: true})) : self.$eval($a));
          lyrics = ($b = file_to_load['$[]']("lyrics"), typeof Opal.compile === 'function' ? eval(Opal.compile($b, {scope_variables: ["filename", "content", "current_lyricist", "audio_path", "file_to_load", "lyrics", "val"], arity_check: false, file: '(eval)', eval: true})) : self.$eval($b));
    ...
    return $def(self, '$build_control_buttons', function $$build_control_buttons() {
      var self = this, play = nil, edit_lyrics = nil, erase = nil, view_importer = nil, record = nil, clear = nil, stop = nil, prev_word = nil, next_word = nil, import_lyrics = nil, close_import = nil, import_drag = nil, save_edited_text = nil, edit_import = nil, save_song = nil, load_song = nil, titesong = nil;
      ...
      edit_lyrics = self.$button((new Map([["label", "Edit"], ["id", "edit_lyrics_button"], ["left", "auto"], ["right", $$('LyricsStyle').$dimensions()['$[]']("margin")], ["top", $$('LyricsStyle').$dimensions()['$[]']("margin")], ["size", $$('LyricsStyle').$dimensions()['$[]']("text_medium")], ["parent", "tool_bar"]])));
      $send(edit_lyrics, 'touch', [true], function $$10(){var self = $$10.$$s == null ? this : $$10.$$s;
        ...
        if ($truthy(self.editor_open)) {
          ...
          return (self.editor_open = false);
        } else {
          
          self.editor_open = true;
          return self.$show_lyrics_editor(33, 33);
        }}, {$$s: self});
      ...
      $send(erase, 'touch', [true], function $$11(){var self = $$11.$$s == null ? this : $$11.$$s;
        ...
        return self.$clear_all()}, {$$s: self});
      view_importer = self.$button((new Map([["id", "import_viewer"], ["label", "lyrics"], ["top", $$('LyricsStyle').$dimensions()['$[]']("margin")], ["left", "auto"], ["right", $$('LyricsStyle').$positions()['$[]']("second_column")], ["parent", "tool_bar"]])));
      $send(view_importer, 'touch', [true], function $$12(){var self = $$12.$$s == null ? this : $$12.$$s, import_drag = nil;
        ...
        if ($eqeq(import_drag.$display(), "none")) {
          return import_drag.$display("block")
        } else {
          return import_drag.$display("none")
        };}, {$$s: self});
      ...
      close_import = self.$button((new Map([["label", "close"], ["id", "close_import"], ["top", $$('LyricsStyle').$dimensions()['$[]']("margin")], ["left", "auto"], ["right", 3], ["parent", "import_module"]])));
      import_drag = self.$grab("import_module");
      $send(close_import, 'touch', [true], function $$21(val){
      ...
      save_edited_text = self.$button((new Map([["label", "save"], ["id", "save_editt"], ["top", $$('LyricsStyle').$dimensions()['$[]']("margin")], ["left", "auto"], ["right", 100], ["parent", "import_module"]])));
      ...
      edit_import = self.$button((new Map([["label", "edit"], ["id", "edit_import"], ["top", $$('LyricsStyle').$dimensions()['$[]']("margin")], ["left", "auto"], ["right", 55], ["parent", "import_module"]])));
      $send(edit_import, 'touch', [true], function $$23(val){var self = $$23.$$s == null ? this : $$23.$$s, text_to_edit = nil;
        ...
        return $send(text_to_edit, 'keyboard', ["down"], function $$24(native_event){var self = $$24.$$s == null ? this : $$24.$$s;

          
          if (native_event == null) native_event = nil;
          return (self.imported_lyrics = text_to_edit.$data());}, {$$s: self});}, {$$s: self});
      import_drag = self.$grab("import_module");
      $send(close_import, 'touch', [true], function $$25(val){
      ...
      save_song = self.$button((new Map([["label", "save"], ["id", "save"], ["top", $$('LyricsStyle').$dimensions()['$[]']("margin")], ["left", 525], ["parent", "bottom_bar"]])));
      $send(save_song, 'touch', [true], function $$26(){var self = $$26.$$s == null ? this : $$26.$$s, lyrics = nil, content_to_save = nil;
        if (self.audio_path == null) self.audio_path = nil;
        if (self.title == null) self.title = nil;

        
        lyrics = self.$grab("lyric_viewer").$content().$to_s();
        content_to_save = (new Map([["lyrics", lyrics], ["song", self.audio_path], ["title", self.title]]));
        return self.$save_file("" + (self.title) + ".lrx", content_to_save);}, {$$s: self});
      load_song = self.$button((new Map([["label", "load"], ["id", "load"], ["top", $$('LyricsStyle').$dimensions()['$[]']("margin")], ["left", 465], ["parent", "bottom_bar"]])));
      $send(load_song, 'import', [true], function $$27(val){var self = $$27.$$s == null ? this : $$27.$$s, current_lyricist = nil;
      ...
      return $send(titesong, 'keyboard', ["down"], function $$28(native_event){var self = $$28.$$s == null ? this : $$28.$$s, event = nil, title = nil;
...
Opal.modules["lyricist_editor"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('box,grab,container_style,text,text_style,[],dimensions,colors,action_button_style,touch,delete,to_h,sort,content,each_with_index,+,*,line_container_style,to_sym,to_s,setup_edit_line_events,build_update_button,build_delete_button,build_add_line_button,private,keyboard,Native,==,preventDefault,to_i,data,!=,[]=,blink,timer,update_lyrics,max,keys,>,full_refresh_viewer,left,top,show_lyrics_editor,size,show_add_dialog,build_dialog_buttons,!,empty?');
  return (function($base, $super, $parent_nesting) {
    var self = $klass($base, $super, 'Lyricist');
    ...
    $def(self, '$show_lyrics_editor', function $$show_lyrics_editor(left_f, top_f) {
      var self = this, editor_container = nil, close_button = nil, lyrics = nil, sorted_lyrics = nil;

      
      editor_container = self.$grab("view").$box($$('LyricsStyle').$container_style((new Map([["id", "lyrics_editor_container"], ["top", top_f], ["left", left_f], ["position", "absolute"], ["overflow", "auto"], ["depth", 4]]))));
      ...
      close_button = editor_container.$box($$('LyricsStyle').$action_button_style((new Map([["width", 25], ["height", 25], ["right", 10], ["top", 10], ["color", $$('LyricsStyle').$colors()['$[]']("danger")]]))));
      close_button.$text($$('LyricsStyle').$text_style((new Map([["data", "X"], ["component", (new Map([["size", $$('LyricsStyle').$dimensions()['$[]']("text_small")]]))], ["color", $$('LyricsStyle').$colors()['$[]']("text_primary")], ["left", 8], ["top", 3]]))));
      $send(close_button, 'touch', [true], function $$1(){var self = $$1.$$s == null ? this : $$1.$$s;

        
        editor_container.$delete((new Map([["recursive", true]])));
        return (self.editor_open = false);}, {$$s: self});
      lyrics = self.$grab("lyric_viewer");
      ...
      $send(sorted_lyrics, 'each_with_index', [], function $$2($mlhs_tmp1, index){var $a, $b, self = $$2.$$s == null ? this : $$2.$$s, timecode = nil, text = nil, y_position = nil, line_container = nil, timecode_field = nil, text_field = nil, update_button = nil, delete_button = nil;
        ...
        timecode_field = line_container.$text($$('LyricsStyle').$text_style((new Map([["id", (("timecode_") + (index)).$to_sym()], ["data", timecode.$to_s()], ["component", (new Map([["size", $$('LyricsStyle').$dimensions()['$[]']("text_normal")]]))], ["edit", true], ["width", 70], ["left", 10], ["top", 10], ["color", $$('LyricsStyle').$colors()['$[]']("text_accent")]]))));
    ...
    $def(self, '$setup_edit_line_events', function $$setup_edit_line_events(line_container, timecode_field, text_field, timecode, lyrics) {
      ...
      $send(timecode_field, 'keyboard', ["dowm"], function $$3(native_event){var self = $$3.$$s == null ? this : $$3.$$s, event = nil, old_timecode = nil, new_timecode = nil, new_text = nil, counter = nil, current_position = nil, max_timecode = nil, prev_position = nil;
        ...
        if ($eqeq(event['$[]']("keyCode").$to_s(), "13")) {
          ...
          return self.$full_refresh_viewer(prev_position);
        } else {
          return nil
        };}, {$$s: self});
    ...
    $def(self, '$build_update_button', function $$build_update_button(line_container, timecode, timecode_field, text_field, lyrics) {
      ...
      $send(update_button, 'touch', [true], function $$5(){var self = $$5.$$s == null ? this : $$5.$$s, old_timecode = nil, new_timecode = nil, new_text = nil, counter = nil, current_position = nil, max_timecode = nil, prev_position = nil;
        ...
        prev_position = self.actual_position;
        return self.$full_refresh_viewer(prev_position);}, {$$s: self});
    ...
    $def(self, '$build_delete_button', function $$build_delete_button(line_container, editor_container, timecode, lyrics) {
      ...
      $send(delete_button, 'touch', [true], function $$6(){var self = $$6.$$s == null ? this : $$6.$$s, prev_left = nil, prev_top = nil, counter = nil, current_position = nil;
        ...
        current_position = counter.$timer()['$[]']("position");
        self.$update_lyrics(current_position, lyrics, counter);
        return self.$full_refresh_viewer(current_position);}, {$$s: self});
    ...
    $def(self, '$build_add_line_button', function $$build_add_line_button(editor_container, sorted_lyrics, lyrics) {
      ...
      add_button = editor_container.$box($$('LyricsStyle').$line_container_style((new Map([["width", 470], ["height", 40], ["left", 10], ["top", $rb_plus(50, $rb_times(sorted_lyrics.$size(), 60))], ["color", $$('LyricsStyle').$colors()['$[]']("success")]]))));
    ...
    return $def(self, '$build_dialog_buttons', function $$build_dialog_buttons(dialog_container, new_timecode_field, new_text_field, editor_container, lyrics) {
      ...
      $send(confirm_button, 'touch', [true], function $$10(){var self = $$10.$$s == null ? this : $$10.$$s, prev_left = nil, prev_top = nil, new_timecode = nil, new_text = nil, counter = nil, current_position = nil;
        ...
        if (($truthy($rb_gt(new_timecode, 0)) && ($not(new_text['$empty?']())))) {
          ...
          editor_container.$delete((new Map([["recursive", true]])));
          return self.$show_lyrics_editor(prev_left, prev_top);
        } else {
...
Opal.modules["lyricist_core"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    $proto.lyrics_anticipation_time = $proto.sorted_keys_cache = $proto.sorted_keys_cache_size = $proto.number_of_lines = $proto.length = $proto.default_length = nil;
    ...
    $def(self, '$format_lyrics', function $$format_lyrics(lyrics_array, target) {
      ...
      if (($neqeq(target.$data(), lyrics_array['$[]'](0)) && ($eqeq(self.$grab("counter").$content(), "play")))) {
        ...
        return $send(lyrics_array, 'each_with_index', [], function $$6(lyric, index){var top_position = nil, child_params = nil;
          ...
          child_params = (new Map([["data", lyric], ["component", (new Map([["size", $$('LyricsStyle').$dimensions()['$[]']("next_Line_lyrics_size")]]))], ["top", top_position]])).$merge(common_style);
...
Opal.modules["list"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $klass = Opal.klass, $rb_times = Opal.rb_times, $send = Opal.send, $eqeq = Opal.eqeq, $def = Opal.def, $truthy = Opal.truthy, $rb_plus = Opal.rb_plus, $thrower = Opal.thrower, $to_ary = Opal.to_ary, $not = Opal.not, $nesting = [], nil = Opal.nil;

  Opal.add_stubs('button,[],dimensions,positions,box,grab,colors,text,*,keyboard,Native,==,to_s,data,blink,preventDefault,touch,display,refresh_song_list,add_current_song_to_list,save_playlist,clear,sort_by,keys,to_i,each,load_song_from_list,delete_song_from_list,alert,reorder_song,+,stop_audio,timer,init_audio,content,full_refresh_viewer,delete,reorder_all_songs,[]=,to_a,each_with_index,empty?,max,map,to_proc,save_file,!,is_a?,build_list_manager');
  return (function($base, $super, $parent_nesting) {
    var self = $klass($base, $super, 'Lyricist');

    var $nesting = [self].concat($parent_nesting), $$ = Opal.$r($nesting), $proto = self.$$prototype;

    $proto.list = $proto.audio_object = $proto.title = $proto.audio_path = $proto.list_title = nil;
    
    
    $def(self, '$build_list_manager', function $$build_list_manager() {
      var self = this, list_button = nil, list_title_bar = nil, title_bar_list_text = nil, close_list = nil, list_container = nil, add_song = nil, save_list = nil;
      ...
      self.$grab("view").$box((new Map([["id", "list_panel"], ["width", 400], ["height", 500], ["top", 50], ["left", 150], ["color", $$('LyricsStyle').$colors()['$[]']("background")], ["border", (new Map([["color", $$('LyricsStyle').$colors()['$[]']("primary")], ["width", 2]]))], ["depth", 10], ["overflow", "auto"], ["display", "none"], ["attach", "tool_bar"], ["drag", true]])));
      ...
      title_bar_list_text = list_title_bar.$text((new Map([["position", "absolute"], ["top", $rb_times($$('LyricsStyle').$dimensions()['$[]']("margin"), 3)], ["left", $rb_times($$('LyricsStyle').$dimensions()['$[]']("margin"), 3)], ["data", "new list"], ["edit", true], ["color", $$('LyricsStyle').$colors()['$[]']("secondary")]])));
      ...
      self.$grab("view").$text((new Map([["content", "Playlist Manager"], ["id", "list_panel_title"], ["width", 300], ["height", 30], ["top", 10], ["left", 10], ["size", $$('LyricsStyle').$dimensions()['$[]']("text_medium")], ["color", "white"], ["attach", "list_title_bar"]])));
      close_list = self.$button((new Map([["label", "close"], ["id", "close_list"], ["top", 5], ["left", "auto"], ["right", 5], ["parent", "list_title_bar"]])));
      list_container = self.$grab("view").$box((new Map([["id", "list_container"], ["width", 380], ["height", 400], ["top", 50], ["left", 10], ["color", $$('LyricsStyle').$colors()['$[]']("background")], ["attach", "list_panel"]])));
      add_song = self.$button((new Map([["label", "new"], ["id", "add_song_to_list"], ["top", 460], ["left", 10], ["parent", "list_panel"]])));
      save_list = self.$button((new Map([["label", "Save"], ["id", "save_list"], ["top", 460], ["left", "auto"], ["right", 10], ["parent", "list_panel"]])));
      $send(list_button, 'touch', [true], function $$2(){var self = $$2.$$s == null ? this : $$2.$$s;
        ...
        if ($eqeq(self.$grab("list_panel").$display(), "none")) {
          ...
          return self.$grab("list_panel").$display("none")
        }}, {$$s: self});
      $send(close_list, 'touch', [true], function $$3(){var self = $$3.$$s == null ? this : $$3.$$s;

        return self.$grab("list_panel").$display("none")}, {$$s: self});
      $send(add_song, 'touch', [true], function $$4(){var self = $$4.$$s == null ? this : $$4.$$s;

        
        self.$add_current_song_to_list();
        return self.$refresh_song_list();}, {$$s: self});
      return $send(save_list, 'touch', [true], function $$5(){var self = $$5.$$s == null ? this : $$5.$$s;

        return self.$save_playlist()}, {$$s: self});
    });
    
    $def(self, '$refresh_song_list', function $$refresh_song_list() {
      var self = this, list_container = nil, sorted_keys = nil, top_position = nil;

      
      list_container = self.$grab("list_container");
      list_container.$clear(true);
      sorted_keys = $send(self.list.$keys(), 'sort_by', [], function $$6(k){
        
        if (k == null) k = nil;
        return k.$to_i();});
      top_position = 10;
      return $send(sorted_keys, 'each', [], function $$7(key){var self = $$7.$$s == null ? this : $$7.$$s, item = nil, item_container = nil, order_input = nil, load_button = nil, delete_button = nil;
        if (self.list == null) self.list = nil;
        ...
        item_container = self.$grab("view").$box((new Map([["id", "song_item_" + (key)], ["width", 360], ["height", 50], ["top", top_position], ["left", 0], ["smooth", 6], ["color", $$('LyricsStyle').$colors()['$[]']("primary")], ["attach", "list_container"]])));
        order_input = self.$grab("view").$text((new Map([["data", key.$to_s()], ["id", "order_" + (key)], ["height", 30], ["position", "absolute"], ["top", 10], ["left", 10], ["edit", true], ["color", "lightgray"], ["attach", "song_item_" + (key)]])));
        self.$grab("view").$text((new Map([["data", item['$[]']("title").$to_s()], ["id", "title_" + (key)], ["width", 200], ["position", "absolute"], ["height", 30], ["top", 10], ["left", 50], ["color", "lightgray"], ["attach", "song_item_" + (key)]])));
        ...
        $send(load_button, 'touch', [true], function $$8(){var self = $$8.$$s == null ? this : $$8.$$s;

          return self.$load_song_from_list(key)}, {$$s: self});
        $send(delete_button, 'touch', [true], function $$9(){var self = $$9.$$s == null ? this : $$9.$$s;

          
          self.$delete_song_from_list(key);
          return self.$refresh_song_list();}, {$$s: self});
        $send(self.$grab("order_" + (key)), 'keyboard', ["down"], function $$10(native_event){var self = $$10.$$s == null ? this : $$10.$$s, event = nil, new_order = nil;
          ...
          if ($eqeq(event['$[]']("keyCode").$to_s(), "13")) {
            ...
            self.$alert(new_order);
            self.$reorder_song(key, new_order);
            self.$refresh_song_list();
            return event.$preventDefault();
          } else {
            return nil
    ...
    $def(self, '$load_song_from_list', function $$load_song_from_list(key) {try { 
      var $a, self = this, song_data = nil, counter = nil, lyrics = nil;
    ...
    $def(self, '$reorder_all_songs', function $$reorder_all_songs() {
      var self = this, sorted_items = nil;
      ...
      sorted_items = $send(self.list.$to_a(), 'sort_by', [], function $$11(k, _){
        ...
        return k.$to_i();});
      self.list = (new Map());
      return $send(sorted_items, 'each_with_index', [], function $$12($mlhs_tmp1, index){var $a, $b, self = $$12.$$s == null ? this : $$12.$$s, _ = nil, item = nil;
        if (self.list == null) self.list = nil;

        
        if ($mlhs_tmp1 == null) $mlhs_tmp1 = nil;
        if (index == null) index = nil;
        $b = $mlhs_tmp1, $a = $to_ary($b), (_ = ($a[0] == null ? nil : $a[0])), (item = ($a[1] == null ? nil : $a[1])), $b;
        return ($a = [$rb_plus(index, 1).$to_s(), item], $send(self.list, '[]=', $a), $a[$a.length - 1]);}, {$$s: self, $$has_top_level_mlhs_arg: true});
    });
    
    $def(self, '$add_current_song_to_list', function $$add_current_song_to_list() {
      ...
      new_song = (new Map([["lyrics", current_lyrics], ["song", self.audio_path], ["title", self.title]]));
...
Opal.queue(function(Opal) {/* Generated by Opal 1.8.2 */
  var $klass = Opal.klass, $def = Opal.def, $truthy = Opal.truthy, $send = Opal.send, $rb_times = Opal.rb_times, self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil;

  Opal.add_stubs('length,play,pause,[],identity_generator,dimensions,colors,box,grab,button_style,text,text_style,timer,[]=,content,data,blink,split,each_with_index,to_sym,*,decorations,touch,alter_lyric_event,audio,display,new,element,init_audio,new_song,initialize_list_manager,init_lyrix');
  ...
  $def(self, '$parse_song_lyrics', function $$parse_song_lyrics(song) {
    ...
    return $send(song_lines, 'each_with_index', [], function $$1(line_found, index){var self = $$1.$$s == null ? this : $$1.$$s, new_id = nil, line_support = nil;
      ...
      return $send(line_support, 'touch', [true], function $$2(){var self = $$2.$$s == null ? this : $$2.$$s, lyrics = nil;

        
        lyrics = self.$grab("lyric_viewer");
        lyrics.$data(line_found);
        return self.$alter_lyric_event();}, {$$s: self});}, {$$s: self});
  });
  ...
  return self.$init_lyrix((new Map([[0, "hi"], [2594, "jeezs"], [8838, "from"], [231295, "hope"]])), "medias/audios/Ices_From_Hells.m4a");
});
