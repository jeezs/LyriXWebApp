Opal.modules["extensions/object"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return $def(self, '$alert', function $$alert(val) {try { 
    ...
    return $$('JS').$eval("alert('" + (escaped_val) + "')");} catch($e) {
      if ($e === Opal.t_eval_return) return $e.$v;
      throw $e;
    }
  }, {$$source_location: ['extensions/object.rb', 4]})
};
...
Opal.modules["extensions/js"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return (function($base, $parent_nesting) {
    ...
    }, {$$source_location: ['extensions/js.rb', 6]});
    ...
    }, {$$source_location: ['extensions/js.rb', 12]});
  })($nesting[0], $nesting)
};
  ...
  return (function($base, $super) {
    ...
    return $def(self, '$geolocation', function $$geolocation() {
      ...
      return $send($send($gvars.window.$navigator().$geolocate(), 'then', [], function $$1(pos){var $a;
        ...
        return ($a = ["longitude", pos.$coords().$longitude()], $send(localisation, '[]=', $a), $a[$a.length - 1]);}, {$$source_location: ['extensions/geolocation.rb', 6]}), 'rescue', [], function $$2(err){var self = $$2.$$s == null ? this : $$2.$$s;

        
        if (err == null) err = nil;
        self.$p(err);
        return nil;}, {$$s: self, $$source_location: ['extensions/geolocation.rb', 6]});
    }, {$$source_location: ['extensions/geolocation.rb', 4]})
  })($nesting[0], null)
};
...
Opal.modules["extensions/ping"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    }, {$$arity: -1, $$source_location: ['extensions/ping.rb', 5]})
...
Opal.modules["extensions/color"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    }, {$$source_location: ['extensions/color.rb', 5]});
    ...
    }, {$$source_location: ['extensions/color.rb', 15]});
  })($nesting[0], null, $nesting)
};
...
Opal.modules["native"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  (function($base, $parent_nesting) {
    ...
    ;
    }, {$$arity: -2, $$source_location: ['./native.rb', 33]});
    ...
    ;
    }, {$$arity: -3, $$source_location: ['./native.rb', 61]});
    $defs(self, '$proc', function $$proc() {
      ...
      return $send($Kernel, 'proc', [], function $$2($a){var $post_args, args, self = $$2.$$s == null ? this : $$2.$$s, instance = nil;
        ...
        $send(args, 'map!', [], function $$3(arg){var self = $$3.$$s == null ? this : $$3.$$s;
          ...
          if (arg == null) arg = nil;
          return self.$Native(arg);}, {$$s: self, $$source_location: ['./native.rb', 91]});
      ...
      ;}, {$$arity: -1, $$s: self, $$source_location: ['./native.rb', 90]});
    }, {$$source_location: ['./native.rb', 87]});
    (function($base, $parent_nesting) {
      ...
      $def(self, '$alias_native', function $$alias_native(new$, $a, $b) {
        ...
        if ($truthy(old['$end_with?']("="))) {
          return $send(self, 'define_method', [new$], function $$4(value){var self = $$4.$$s == null ? this : $$4.$$s;
            ...
            return value;}, {$$s: self, $$source_location: ['./native.rb', 151]})
        } else if ($truthy(as)) {
          return $send(self, 'define_method', [new$], function $$5($c){var block = $$5.$$p || nil, $post_args, args, self = $$5.$$s == null ? this : $$5.$$s, value = nil;
            ...
            if ($truthy(value)) {
              ...
              return nil
            };}, {$$arity: -1, $$s: self, $$source_location: ['./native.rb', 157]})
        } else {
          return $send(self, 'define_method', [new$], function $$6($c){var block = $$6.$$p || nil, $post_args, args, self = $$6.$$s == null ? this : $$6.$$s;
            ...
            $post_args = $slice(arguments);
            args = $post_args;
            return $send($$('Native'), 'call', [self["native"], old].concat($to_a(args)), block.$to_proc());}, {$$arity: -1, $$s: self, $$source_location: ['./native.rb', 164]})
        };
      }, {$$arity: -2, $$source_location: ['./native.rb', 149]});
      ...
      $def(self, '$native_reader', function $$native_reader($a) {
        ...
        return $send(names, 'each', [], function $$7(name){var self = $$7.$$s == null ? this : $$7.$$s;
          ...
          return $send(self, 'define_method', [name], function $$8(){var self = $$8.$$s == null ? this : $$8.$$s;
            ...
            return self.$Native(self["native"][name])}, {$$s: self, $$source_location: ['./native.rb', 172]});}, {$$s: self, $$source_location: ['./native.rb', 171]});
      }, {$$arity: -1, $$source_location: ['./native.rb', 170]});
      ...
      $def(self, '$native_writer', function $$native_writer($a) {
        ...
        return $send(names, 'each', [], function $$9(name){var self = $$9.$$s == null ? this : $$9.$$s;
          ...
          return $send(self, 'define_method', ["" + (name) + "="], function $$10(value){var self = $$10.$$s == null ? this : $$10.$$s;
            ...
            if (value == null) value = nil;
            return self.$Native(self["native"][name] = value);}, {$$s: self, $$source_location: ['./native.rb', 180]});}, {$$s: self, $$source_location: ['./native.rb', 179]});
      }, {$$arity: -1, $$source_location: ['./native.rb', 178]});
      ...
      }, {$$arity: -1, $$source_location: ['./native.rb', 186]});
    })($nesting[0], $nesting);
    (function($base, $parent_nesting) {
      ...
      }, {$$source_location: ['./native.rb', 193]});
      
      $def(self, '$to_n', $return_ivar("native"), {$$source_location: ['./native.rb', 202]});
      return $defs(self, '$included', function $$included(klass) {
        
        return klass.$extend($$('Helpers'))
      }, {$$source_location: ['./native.rb', 206]});
    })($nesting[0], $nesting);
  ...
  (function($base, $parent_nesting) {
    ...
    $def(self, '$Native', function $$Native(obj) {
      ...
      if ($truthy(obj == null)) {
        ...
        return $send(obj, 'map', [], function $$12(o){var self = $$12.$$s == null ? this : $$12.$$s;
          ...
          if (o == null) o = nil;
          return self.$Native(o);}, {$$s: self, $$source_location: ['./native.rb', 233]})
        ...
        return $send(self, 'proc', [], function $$13($a){var block = $$13.$$p || nil, $post_args, args, self = $$13.$$s == null ? this : $$13.$$s;
          ...
          $post_args = $slice(arguments);
          args = $post_args;
          return self.$Native($send(obj, 'call', $to_a(args), block.$to_proc()));}, {$$arity: -1, $$s: self, $$source_location: ['./native.rb', 237]})
      } else {
        return obj
      }
    }, {$$source_location: ['./native.rb', 227]});
    ...
    }, {$$arity: -2, $$source_location: ['./native.rb', 248]});
  })($nesting[0], $nesting);
  (function($base, $super) {
    ...
    }, {$$arity: -1, $$source_location: ['./native.rb', 267]});
    ...
    }, {$$arity: -2, $$source_location: ['./native.rb', 316]});
    ...
    $def(self, '$respond_to_missing?', function $Object_respond_to_missing$ques$20(name, include_all) {
      ...
      if (include_all == null) include_all = false;
      return Opal.hasOwnProperty.call(self["native"], name);
    }, {$$arity: -2, $$source_location: ['./native.rb', 320]});
    ...
    ;
    }, {$$arity: -2, $$source_location: ['./native.rb', 324]});
    
    $def(self, '$nil?', $return_val(false), {$$source_location: ['./native.rb', 335]});
    
    $def(self, '$is_a?', function $Object_is_a$ques$21(klass) {
      var self = this;

      return Opal.is_a(self, klass);
    }, {$$source_location: ['./native.rb', 339]});
    
    $def(self, '$instance_of?', function $Object_instance_of$ques$22(klass) {
      var self = this;

      return self.$$class === klass;
    }, {$$source_location: ['./native.rb', 343]});
    
    $def(self, '$class', function $Object_class$23() {
      var self = this;

      return self.$$class;
    }, {$$source_location: ['./native.rb', 347]});
    ...
    }, {$$arity: -1, $$source_location: ['./native.rb', 351]});
    
    $def(self, '$inspect', function $$inspect() {
      var self = this;

      return "#<Native:" + (String(self["native"])) + ">"
    }, {$$source_location: ['./native.rb', 355]});
  ...
  (function($base, $super, $parent_nesting) {
    ...
    }, {$$arity: -2, $$source_location: ['./native.rb', 369]});
    ...
    }, {$$arity: -1, $$source_location: ['./native.rb', 420]});
    
    $def(self, '$length', function $$length() {
      var self = this;

      return self["native"][self.length]
    }, {$$source_location: ['./native.rb', 436]});
    
    $def(self, '$inspect', function $$inspect() {
      var self = this;

      return self.$to_a().$inspect()
    }, {$$source_location: ['./native.rb', 440]});
  ...
  (function($base, $super) {
    ...
    return $def(self, '$to_n', function $$to_n() {
      ...
      return self.valueOf();
    }, {$$source_location: ['./native.rb', 449]})
  })($nesting[0], null);
  (function($base, $super) {
    var self = $klass($base, $super, 'Proc');

    
    return $def(self, '$to_n', $return_self, {$$source_location: ['./native.rb', 456]})
  })($nesting[0], null);
  (function($base, $super) {
  ...
  (function($base, $super) {
    ...
    return $def(self, '$to_n', function $$to_n() {
      ...
      return self.valueOf();
    }, {$$source_location: ['./native.rb', 470]})
  })($nesting[0], null);
  (function($base, $super) {
    var self = $klass($base, $super, 'MatchData');

    
    return $def(self, '$to_n', $return_ivar("matches"), {$$source_location: ['./native.rb', 477]})
  })($nesting[0], null);
  (function($base, $super, $parent_nesting) {
    ...
    return $def(self, '$to_n', function $$to_n() {
      ...
      $send(self, 'each_pair', [], function $$26(name, value){
        ...
        if (name == null) name = nil;
        if (value == null) value = nil;
        return result[name] = $$('Native').$try_convert(value, value);}, {$$source_location: ['./native.rb', 488]});
      return result;
    }, {$$source_location: ['./native.rb', 485]})
  })($nesting[0], null, $nesting);
  (function($base, $super, $parent_nesting) {
    var self = $klass($base, $super, 'Array');
  ...
  (function($base, $super) {
    ...
    return $def(self, '$to_n', function $$to_n() {
      ...
      return self.valueOf();
    }, {$$source_location: ['./native.rb', 515]})
  })($nesting[0], null);
  (function($base, $super) {
    var self = $klass($base, $super, 'Time');

    
    return $def(self, '$to_n', $return_self, {$$source_location: ['./native.rb', 522]})
  })($nesting[0], null);
  (function($base, $super) {
  ...
  if (!$truthy($$('Hash')['$method_defined?']("_initialize"))) {
    ...
    ;
      ...
      ;
      }, {$$arity: -1, $$source_location: ['./native.rb', 565]});
      return $def(self, '$to_n', function $$to_n() {
        var self = this;
...
Opal.modules["promise"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  (function($base, $super, $parent_nesting) {
    ...
    }, {$$arity: -1, $$source_location: ['./promise.rb', 109]});
    ...
    $def(self, '$initialize', function $$initialize(action) {
      ...
      self.prev = nil;
      return (self.next = []);
    }, {$$arity: -1, $$source_location: ['./promise.rb', 115]});
    ...
    }, {$$source_location: ['./promise.rb', 128]});
    ...
    $def(self, '$^', function $Promise_$$5(promise) {
      ...
      self['$>>'](promise);
      return promise;
    }, {$$source_location: ['./promise.rb', 160]});
    ...
    $def(self, '$<<', function $Promise_$lt$lt$6(promise) {
      ...
      self.prev = promise;
      return self;
    }, {$$source_location: ['./promise.rb', 167]});
    ...
    $def(self, '$>>', function $Promise_$gt$gt$7(promise) {
      ...
      return self;
    }, {$$source_location: ['./promise.rb', 173]});
    ...
    $def(self, '$resolve', function $$resolve(value) {
      ...
      return self;
    }, {$$arity: -1, $$source_location: ['./promise.rb', 191]});
    ...
    $def(self, '$resolve!', function $Promise_resolve$excl$8(value) {
      ...
      if ($truthy(self.next['$any?']())) {
        return $send(self.next, 'each', [], function $$9(p){
          ...
          if (p == null) p = nil;
          return p.$resolve(value);}, {$$source_location: ['./promise.rb', 219]})
      } else {
        return (self.delayed = [value])
      };
    }, {$$source_location: ['./promise.rb', 214]});
    ...
    $def(self, '$reject', function $$reject(value) {
      ...
      return self;
    }, {$$arity: -1, $$source_location: ['./promise.rb', 225]});
    ...
    $def(self, '$reject!', function $Promise_reject$excl$10(value) {
      ...
      if ($truthy(self.next['$any?']())) {
        return $send(self.next, 'each', [], function $$11(p){
          ...
          if (p == null) p = nil;
          return p.$reject(value);}, {$$source_location: ['./promise.rb', 257]})
      } else {
        return (self.delayed = [value])
      };
    }, {$$source_location: ['./promise.rb', 252]});
    ...
    }, {$$source_location: ['./promise.rb', 263]});
    ...
    }, {$$source_location: ['./promise.rb', 269]});
    ...
    }, {$$source_location: ['./promise.rb', 273]});
    ...
    }, {$$source_location: ['./promise.rb', 278]});
    ...
    }, {$$source_location: ['./promise.rb', 282]});
    ...
    }, {$$source_location: ['./promise.rb', 287]});
    ...
    }, {$$source_location: ['./promise.rb', 291]});
    ...
    }, {$$arity: -1, $$source_location: ['./promise.rb', 296]});
    ...
    }, {$$arity: -1, $$source_location: ['./promise.rb', 300]});
    ...
    }, {$$source_location: ['./promise.rb', 305]});
    ...
    $def(self, '$inspect', function $$inspect() {
      ...
      return result;
    }, {$$source_location: ['./promise.rb', 311]});
    ...
    $def(self, '$to_v2', function $$to_v2() {
      ...
      $send($send(self, 'then', [], function $$18(i){
        ...
        if (i == null) i = nil;
        return v2.$resolve(i);}, {$$source_location: ['./promise.rb', 330]}), 'rescue', [], function $$19(i){
        
        if (i == null) i = nil;
        return v2.$reject(i);}, {$$source_location: ['./promise.rb', 330]});
      return v2;
    }, {$$source_location: ['./promise.rb', 327]});
    ...
    (function($base, $super, $parent_nesting) {
      ...
      }, {$$source_location: ['./promise.rb', 352]});
      return $def(self, '$initialize', function $$initialize(depth, block) {
        ...
        return $send2(self, $find_super(self, 'initialize', $$initialize, false, true), 'initialize', [(new Map([["success", $send(self, 'proc', [], function $$20(){var self = $$20.$$s == null ? this : $$20.$$s, trace = nil;
          ...
          return $send(block, 'call', $to_a(trace));}, {$$s: self, $$source_location: ['./promise.rb', 370]})]]))], null);
      }, {$$source_location: ['./promise.rb', 367]});
    ...
    return (function($base, $super, $parent_nesting) {
      ...
      $def(self, '$initialize', function $$initialize(promises) {
        ...
        return $send(promises, 'each', [], function $$21(promise){var self = $$21.$$s == null ? this : $$21.$$s;
          ...
          return self.$wait(promise);}, {$$s: self, $$source_location: ['./promise.rb', 389]});
      }, {$$arity: -1, $$source_location: ['./promise.rb', 384]});
      ...
      $def(self, '$each', function $$each() {
        ...
        return $send(self, 'then', [], function $$22(values){
          ...
          return $send(values, 'each', [], block.$to_proc());}, {$$source_location: ['./promise.rb', 397]});
      }, {$$source_location: ['./promise.rb', 394]});
      ...
      $def(self, '$collect', function $$collect() {
        ...
        return $send(self, 'then', [], function $$23(values){
          ...
          if (values == null) values = nil;
          return $$('When').$new($send(values, 'map', [], block.$to_proc()));}, {$$source_location: ['./promise.rb', 405]});
      }, {$$source_location: ['./promise.rb', 402]});
      ...
      $def(self, '$inject', function $$inject($a) {
        ...
        return $send(self, 'then', [], function $$24(values){
          ...
          if (values == null) values = nil;
          return $send(values, 'reduce', $to_a(args), block.$to_proc());}, {$$source_location: ['./promise.rb', 411]});
      }, {$$arity: -1, $$source_location: ['./promise.rb', 410]});
      ...
      $def(self, '$wait', function $$wait(promise) {
        ...
        $send(promise, 'always', [], function $$25(){var self = $$25.$$s == null ? this : $$25.$$s;
          ...
          if ($truthy(self.next['$any?']())) {
            ...
            return nil
          }}, {$$s: self, $$source_location: ['./promise.rb', 427]});
        return self;
      }, {$$source_location: ['./promise.rb', 416]});
      ...
      $def(self, '$>>', function $When_$gt$gt$26($a) {
        ...
        return $send($send2(self, $find_super(self, '>>', $When_$gt$gt$26, false, true), '>>', $to_a($fwd_rest), $yield), 'tap', [], function $$27(){var self = $$27.$$s == null ? this : $$27.$$s;
          ...
          return self.$try()}, {$$s: self, $$source_location: ['./promise.rb', 435]});
      }, {$$arity: -1, $$source_location: ['./promise.rb', 434]});
      ...
      }, {$$source_location: ['./promise.rb', 440]});
